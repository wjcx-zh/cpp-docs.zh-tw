...
|名稱|說明|  
|----------|-----------------|  
|[CPoint::Offset](#offset)|將值加入**x**和**y**成員`CPoint`。|  
  
### <a name="public-operators"></a>公用運算子  
  
|名稱|說明|  
|----------|-----------------|  
|[CPoint::operator-](#operator_-)|傳回的差異`CPoint`和大小或點或兩個點或位移的負數大小的大小差異的否定運算。|  
|[CPoint::operator ！ =](#operator_neq)|檢查兩個點之間不相等。|  
|[CPoint::operator +](#operator_add)|傳回總和`CPoint`和大小或點，或`CRect`位移的大小。|  
|[CPoint::operator + =](#operator_add_eq)|位移`CPoint`藉由新增大小或點。|  
...
### <a name="remarks"></a>備註  
 ...
 例如，加入`CPoint(5, -7)`，其中包含此變數`CPoint(30, 40)`變更變數`CPoint(35, 33)`。  
...
### <a name="remarks"></a>備註  
 ...
 例如，減去`CPoint(5, -7)`的變數，其中包含從`CPoint(30, 40)`變更變數`CPoint(25, 47)`。  
...
### <a name="remarks"></a>備註  
 第三個多載位移`CRect`的否定的`CPoint`。 最後，使用要變換正負號的一元運算子`CPoint`。  
