...
|[Collection](../atl/collection-classes.md)|[物件安全。](../atl/object-safety-classes.md)|  
...
|[資料轉送](../atl/data-transfer-classes.md)|[服務提供者支援](../atl/service-provider-support-classes.md)|  
|[資料型別](../atl/data-types-classes.md)|[網站資訊](../atl/site-information-classes.md)|  
...
|[錯誤訊息](../atl/error-information-classes.md)|[執行緒模型和關鍵區段](../atl/threading-models-and-critical-sections-classes.md)|  
...
|[IUnknown 實作](../atl/iunknown-implementation-classes.md)|[公用程式](../atl/utility-classes.md)|  
 ...
 如需可在 ATL 專案的其他類別，請參閱 [共用類別](../atl-mfc-shared/atl-mfc-shared-classes.md)。  
