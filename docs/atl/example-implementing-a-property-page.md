...
## <a name="overriding-ipropertypageimplactivate"></a><a name="vcconoverriding_ipropertypageimpl_activate"></a> 覆寫 IPropertyPageImpl::Activate
...
## <a name="creating-a-macro"></a><a name="vcconcreating_a_macro"></a> 建立巨集
