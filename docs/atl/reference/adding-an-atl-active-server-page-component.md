...
-   您可以將 ASP 元件內嵌至您的 HTML 頁面，以建立動態的瀏覽器無關的內容。  
  
-   您可以使用 ASP 網頁可提供標準基礎資料庫的連線。  
  
-   網頁型應用程式，您可以使用 ASP 錯誤處理功能。  
  
### <a name="to-add-an-atl-active-server-pages-component-to-your-project"></a>將 ATL Active Server Pages 元件新增至您的專案  
  
1.  在**方案總管 中**或[類別檢視](http://msdn.microsoft.com/en-us/8d7430a9-3e33-454c-a9e1-a85e3d2db925)，以滑鼠右鍵按一下您要加入 ATL Active Server Pages 元件專案的名稱。  
