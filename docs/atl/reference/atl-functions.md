...
若要依分類尋找 ATL 函式，請參閱下列主題。  
 ...
 [封送處理的全域函式](../../atl/reference/marshaling-global-functions.md)  
 提供支援封送處理和轉換成介面指標封送處理資料。  
  
 [像素/HIMETRIC 轉換全域函式](../../atl/reference/pixel-himetric-conversion-global-functions.md)  
 提供支援的轉換，並與像素和 himetric 為單位。  
  
 [登錄和型別程式庫全域函式](../../atl/reference/registry-and-typelib-global-functions.md)  
 載入和註冊類型程式庫提供支援。  
  
 [安全性的全域函式](../../atl/reference/security-global-functions.md)  
 提供修改 SID 和 ACL 物件的支援。  
  
 [安全性識別碼的全域函式](../../atl/reference/security-identifier-global-functions.md)  
 傳回物件的一般已知的 SID。  
