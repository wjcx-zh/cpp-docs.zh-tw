...
*strTime*<br/>
接收 HTTP 日期時間，如 RFC 2616 中所定義的字串變數的參考 ([https://www.ietf.org/rfc/rfc2616.txt](https://www.ietf.org/rfc/rfc2616.txt)) 和 RFC 1123 ([https://www.ietf.org/rfc/rfc1123.txt](https://www.ietf.org/rfc/rfc1123.txt))。
