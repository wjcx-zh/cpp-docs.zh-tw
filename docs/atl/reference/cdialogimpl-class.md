...
|對話方塊|[對話方塊](/windows/desktop/dlgbox/dialog-boxes)和後續 Windows SDK 中的主題|
...
**RECT &** *rect* [in] [RECT](/previous-versions/dd162897\(v=vs.85\))結構，指定對話方塊的大小和位置。
