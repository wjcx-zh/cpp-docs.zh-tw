...
這個方法的第二個版本可讓您將轉換的座標[RECT](/previous-versions/dd162897\(v=vs.85\))結構。
...
這個方法的第二個版本會使用[RECT](/previous-versions/dd162897\(v=vs.85\))結構，以決定視窗的新位置、 寬度和高度。
