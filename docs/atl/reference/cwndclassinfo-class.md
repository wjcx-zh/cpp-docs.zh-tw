...
如需視窗類別的詳細資訊，請參閱[視窗類別](/windows/desktop/winmsg/window-classes)Windows SDK 中。
...
維護中的視窗類別資訊[WNDCLASSEX](/windows/desktop/api/winuser/ns-winuser-tagwndclassexa)結構。
