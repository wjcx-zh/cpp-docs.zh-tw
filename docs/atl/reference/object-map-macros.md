...
|||  
|-|-|  
|[DECLARE_OBJECT_DESCRIPTION](#declare_object_description)|可讓您指定的類別物件的文字描述，將會輸入到物件對應。|  
|[OBJECT_ENTRY_AUTO](#object_entry_auto)|進入物件對應中的 ATL 物件，更新登錄中，並建立物件的執行個體。|  
...
|類別處理站的建立|[類別的 Factory 巨集](../../atl/reference/aggregation-and-class-factory-macros.md)|  
