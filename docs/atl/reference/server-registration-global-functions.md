...
*dwClsContext*<br/>
指定要執行的類別物件的內容。 可能的值為 CLSCTX_INPROC_SERVER、 CLSCTX_INPROC_HANDLER 或 CLSCTX_LOCAL_SERVER。 請參閱[CLSCTX](/windows/desktop/api/wtypesbase/ne-wtypesbase-tagclsctx)如需詳細資訊。
