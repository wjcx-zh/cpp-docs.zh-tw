---
title: EVENT_ID 列舉
description: C++ BUILD Insights SDK EVENT_ID 列舉參考。
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "78333780"
---
# <a name="event_id-enum"></a>EVENT_ID 列舉
...
| `EVENT_ID_COMPILER` | 7（0x00000007） | [編譯器](../event-table.md#compiler) |
...
| `EVENT_ID_LINKER` | 18（0x00000012） | [連結器](../event-table.md#linker) |
...
| `EVENT_ID_THREAD` | 29（0x0000001D） | [執行緒](../event-table.md#thread) |
