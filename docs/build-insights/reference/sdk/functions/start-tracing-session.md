---
title: 開始追蹤工作階段
description: C++生成見解 SDK 開始跟蹤會話函數引用。
ms.date: 02/12/2020
helpviewer_keywords:
- C++ Build Insights
...
ms.locfileid: "81323742"
---
# <a name="starttracingsession"></a>開始追蹤工作階段
...
函數`StartTracingSession`啟動跟蹤會話。 調用此函數的可執行文件必須具有管理員許可權。
...
*工作階段名稱*\
要啟動的跟蹤作業的名稱。 呼叫[停止追蹤作業階段](stop-tracing-session.md)或任何其他停止追蹤函數時使用相同的名稱。
