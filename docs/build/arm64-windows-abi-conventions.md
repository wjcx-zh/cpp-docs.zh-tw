...
| 登錄 | 動態？ | 角色 |
| - | - | - |
| x0 | Volatile | 參數/臨時暫存器1，結果註冊 |
| x1-7 | Volatile | 參數/臨時暫存器2-8 |
| x8-x15 | Volatile | 臨時暫存器 |
| x16-x17 | Volatile | 程式內呼叫的臨時暫存器 |
...
| 登錄 | 動態？ | 角色 |
| - | - | - |
| v0 | Volatile | 參數/臨時暫存器1，結果註冊 |
| v1-v7 | Volatile | 參數/臨時暫存器2-8 |
| v8-v15 | 靜態 | 臨時暫存器（只有低64位不會變動） |
| v16-v31 | Volatile | 臨時暫存器 |
