...
ms.locfileid: "69493284"
---
# <a name="configure-c-projects-for-64-bit-x64-targets"></a>設定C++ 64 位、x64 目標的專案

本節包含使用 Visual C++ build tools 以64位 x64 硬體為目標的主題。

## <a name="in-this-section"></a>本節內容

- [如何：將 Visual C++ 專案設定為以 64 位元 x64 平台為目標](how-to-configure-visual-cpp-projects-to-target-64-bit-platforms.md)

- [如何：在命令列上啟用64位、x64 主控的 MSVC 工具組](how-to-enable-a-64-bit-visual-cpp-toolset-on-the-command-line.md)
...
[.NET Framework 64 位應用程式](/dotnet/framework/64-bit-apps)
...
[64位 Windows 程式設計指南](/windows/win32/WinProg64/programming-guide-for-64-bit-windows)
