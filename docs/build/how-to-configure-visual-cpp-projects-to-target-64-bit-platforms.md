---
title: 作法：將 Visual Studio C++專案設定為以64位、x64 平臺為目標
ms.date: 11/04/2016
helpviewer_keywords:
- platforms [C++], 64-bit
...
---
# <a name="how-to-configure-visual-studio-c-projects-to-target-64-bit-x64-platforms"></a>HOW TO：將 Visual Studio C++專案設定為以64位、x64 平臺為目標

您可以使用 Visual Studio IDE 中的專案設定, 將C++應用程式設定為以64位 x64 平臺為目標。 您也可以將 Win32 專案設定移轉至 64 位元專案組態。
