...
|登錄|動態？|角色|
|--------------|---------------|----------|
|r0|Volatile|參數、結果、臨時暫存器 1|
|r1|Volatile|參數、結果、臨時暫存器 2|
|r2|Volatile|參數、臨時暫存器 3|
|r3|Volatile|參數、臨時暫存器 4|
|r4|靜態||
|r5|靜態||
|r6|靜態||
|r7|靜態||
...
|單核心|雙核心|四核心|動態？|角色|
|-------------|-------------|-----------|---------------|----------|
|s0-s3|d0-d1|q0|Volatile|參數、結果、臨時暫存器|
|s4-s7|d2-d3|q1|Volatile|參數、臨時暫存器|
|s8-s11|d4-d5|q2|Volatile|參數、臨時暫存器|
|s12-s15|d6-d7|q3|Volatile|參數、臨時暫存器|
|s16-s19|d8-d9|q4|靜態||
...
|Bits|意義|動態？|角色|
|----------|-------------|---------------|----------|
|31-28|NZCV|Volatile|狀態旗標|
|27|QC|Volatile|累加飽和度|
|26|AHP|靜態|替代半精確度控制|
...
|7, 4-0|IDC、IXC 等|Volatile|累加例外狀況旗標|
