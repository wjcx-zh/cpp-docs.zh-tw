...
![在 效能及診斷中樞的 PGO](media/pgofig0hub.png "效能及診斷中樞中的 PGO")

在 **可用的工具**，選取**特性指引最佳化**核取方塊。 選擇**啟動** 按鈕，啟動 PGO 外掛程式。

![PGO 簡介頁面](media/pgofig1start.png "PGO 簡介頁面")

**特性指引最佳化**頁面描述外掛程式用來改善您的應用程式效能的步驟。 選擇**啟動** 按鈕。

![PGO 檢測頁面](media/pgofig2instrument.png "PGO 檢測頁面")
...
![PGO 檢測的建置頁面](media/pgofig3build.PNG "PGO 檢測的建置頁面")
...
![PGO 定型頁面](media/pgofig4training.PNG "PGO 定型頁面")
...
![PGO 分析頁面](media/pgofig5analyze.png "PGO 分析頁面")
