# [建置參考](c-cpp-building-reference.md)
...
### [先行編譯標頭檔的一致性規則](precompiled-header-consistency-rules.md)
#### [針對每個檔案使用的先行編譯標頭檔的一致性規則](consistency-rules-for-per-file-use-of-precompiled-headers.md)
#### [-Yc 和 -Yu 的一致性規則](consistency-rules-for-yc-and-yu.md)
### [在專案中使用先行編譯標頭檔](using-precompiled-headers-in-a-project.md)
