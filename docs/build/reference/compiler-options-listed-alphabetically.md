---
title: "依字母順序排列的編譯器選項 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
|[\/Tc](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TC](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|指定 C 原始程式檔。|  
|[\/Tp](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)<br /><br /> [\/TP](../../build/reference/tc-tp-tc-tp-specify-source-file-type.md)|指定 C\+\+ 原始程式檔。|  
...
|[\/Zc](../../build/reference/zc-conformance.md)|指定 [\/Ze](../../build/reference/za-ze-disable-language-extensions.md) 下的標準行為。[\/Za、\/Ze \(停用語言擴充功能\)](../../build/reference/za-ze-disable-language-extensions.md)|  
