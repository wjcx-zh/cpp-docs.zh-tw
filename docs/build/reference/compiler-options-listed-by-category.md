...
| [`/Yc`](yc-create-precompiled-header-file.md) | 建立檔案 *`.PCH`* 。 |
...
| 選項 | 用途 |
|--|--|
| [`/clr:noAssembly`](clr-common-language-runtime-compilation.md) | 已被取代。 請改用[ `/LN` (建立 MSIL 模組) ](ln-create-msil-module.md) 。 |
| [`/errorReport`](errorreport-report-internal-compiler-errors.md) | 已被取代。 錯誤報表是由[Windows 錯誤報告 (WER) ](/windows/win32/wer/windows-error-reporting)設定來控制。 |
| [`/Fr`](fr-fr-create-dot-sbr-file.md) | 已被取代。 建立不包含本機變數的瀏覽資訊檔。 |
| [`/Ge`](ge-enable-stack-probes.md) | 已被取代。 啟動堆疊探查。 預設為 [開啟]。 |
| [`/Gm`](gm-enable-minimal-rebuild.md) | 已被取代。 啟用最少重建。 |
| [`/GX`](gx-enable-exception-handling.md) | 已被取代。 啟用同步例外狀況處理。 請改用 [`/EH`](eh-exception-handling-model.md) 。 |
| [`/GZ`](gz-enable-stack-frame-run-time-error-checking.md) | 已被取代。 啟用快速檢查。 請改用 [`/RTC1`](rtc-run-time-error-checks.md) 。 |
| [`/H`](h-restrict-length-of-external-names.md) | 已被取代。 限制外部 (公用) 名稱的長度。 |
| [`/Og`](og-global-optimizations.md) | 已被取代。 使用全域最佳化。 |
| [`/QIfist`](qifist-suppress-ftol.md) | 已被取代。 曾用以指定如何從浮點型別轉換為整數型別。 |
| [`/V`](v-version-number.md) | 已被取代。 設定檔案 *`.obj`* 版本字串。 |
