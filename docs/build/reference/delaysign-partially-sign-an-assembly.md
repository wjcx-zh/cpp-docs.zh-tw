...
**/DELAYSIGN**選項沒有任何作用，除非搭配[/KEYFILE](keyfile-specify-key-or-key-pair-to-sign-an-assembly.md)或是[/KEYCONTAINER](keycontainer-specify-a-key-container-to-sign-an-assembly.md)。
