...
**在 PogoSafeMode 和 VCPROFILE_ALLOC_SCALE 環境變數已被取代從 Visual Studio 2015 開始。** 連結器選項[/GENPROFILE 或 /FASTGENPROFILE](genprofile-fastgenprofile-generate-profiling-instrumented-build.md)並[/USEPROFILE](useprofile.md)為這些環境變數指定相同的連結器行為。
