...
ms.locfileid: "62270975"
---
# <a name="fs-force-synchronous-pdb-writes"></a>/FS (強制同步 PDB 寫入)

強制寫入要程式資料庫 (PDB) 檔案，由[/Zi](z7-zi-zi-debug-information-format.md)或[/ZI](z7-zi-zi-debug-information-format.md)— 透過 MSPDBSRV 序列化。EXE。
...
[/MP](mp-build-with-multiple-processes.md)選項可讓 **/FS**預設。
