...
ms.locfileid: "68299777"
---
# <a name="general-property-page-project"></a>一般屬性頁 (專案)

::: moniker range=">=vs-2019"

本主題適用于 Windows 的 Visual Studio 專案。 針對 Linux 專案, 請[參閱C++ Linux 屬性頁參考](../../linux/prop-pages-linux.md)。 如需 CMake 專案, 請參閱[在 Visual Studio 中 CMake 專案](../cmake-projects-in-visual-studio.md)。
...
- **平台工具組**
   ...
   可讓專案以不同版本的 Visual C++ 程式庫和編譯器為目標。 Visual Studio C++專案可以針對 Visual Studio 所安裝的預設工具組, 或是數個舊版 Visual Studio 所安裝的其中一個工具組, 包括建立可在 windows XP 上執行之可執行檔的工具組。 如需變更平臺工具組的相關資訊[, 請參閱如何:修改目標 Framework 和平台工具組](../how-to-modify-the-target-framework-and-platform-toolset.md)。
...
在 Visual Studio 2015 和 Visual Studio 2017 中, 當您以滑鼠右鍵按一下**方案總管**中的專案節點, 然後選取 [**屬性**] 時, 左窗格中 [設定**屬性**] 節點底下的 [**一般**] 屬性頁會顯示屬性的兩個區段:
