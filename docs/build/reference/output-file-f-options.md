...
-   [/Fd （PDB 檔案名稱）](../../build/reference/fd-program-database-file-name.md)  
...
-   [/FU (命名強制 #using 檔案)](../../build/reference/fu-name-forced-hash-using-file.md)  
