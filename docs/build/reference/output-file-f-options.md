...
輸出檔選項會建立或重新命名輸出檔。  它們會影響在 CL 環境變數、命令列或任何命令檔中指定的所有 C 或 C\+\+ 原始程式檔。  
  
-   [\/FA、\/Fa \(清單檔\)](../../build/reference/fa-fa-listing-file.md)  
  
-   [指定路徑名稱](../../build/reference/specifying-the-pathname.md)  
  
-   [\/Fd \(命名 PDB 檔案\)](../../build/reference/fd-program-database-file-name.md)  
...
-   [\/Fo \(命名目的檔\)](../../build/reference/fo-object-file-name.md)  
