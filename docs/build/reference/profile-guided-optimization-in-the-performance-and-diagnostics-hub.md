...
---
# <a name="profile-guided-optimization-in-the-performance-and-diagnostics-hub"></a>效能及診斷中樞中的特性指引最佳化
[效能及診斷中樞] 中 Visual C++ 外掛程式的特性指引最佳化，可讓開發人員的特性指引最佳化經驗更加順暢。 您可以[下載外掛程式](http://go.microsoft.com/fwlink/p/?LinkId=327915)從 Visual Studio 網站。  
...
2.  在左窗格中**新專案**對話方塊方塊中，展開 **已安裝**，**範本**， **Visual c + +**，然後選取**MFC**。  
  
3.  在中央窗格中，選取**MFC 應用程式**。  
  
4.  指定專案的名稱 — 例如， **SamplePGOProject**— 在**名稱**方塊。 選擇 [確定]  按鈕。  
  
5.  在**概觀**頁面**MFC 應用程式精靈**對話方塊方塊中，選擇**完成** 按鈕。  
...
2.  在**Configuration Manager**對話方塊方塊中，選擇**現用方案組態**下拉式按鈕，然後選取**發行**。 選擇**關閉** 按鈕。  
