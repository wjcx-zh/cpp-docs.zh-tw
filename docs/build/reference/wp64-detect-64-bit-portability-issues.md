...
如果您經常使用建置 64 位元、 x64 編譯器編譯您的應用程式程式碼中，您可以只停用 **/wp64**在 32 位元編譯中因為 64 位元編譯器會偵測到的所有問題。 如需如何目標是 Windows 64 位元作業系統的詳細資訊，請參閱[64 位元、 x64 目標設定的 c + + 專案](../configuring-programs-for-64-bit-visual-cpp.md)。
...
[設定適用於 64 位元、 x64 的 c + + 專案的目標](../configuring-programs-for-64-bit-visual-cpp.md)
