...
**/Yd**已被取代;視覺化C++現在支援多個物件寫入至單一的.pdb 檔案，使用 **/Zi**改為。 如需已被取代的編譯器選項的清單，請參閱 <<c0>  **已取代及移除的編譯器選項**中[依分類排列的編譯器選項](compiler-options-listed-by-category.md)。
