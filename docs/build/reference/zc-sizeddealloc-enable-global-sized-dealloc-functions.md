...
**/Zc:sizedDealloc**編譯器選項預設為開啟。 [/ 寬鬆-](permissive-standards-conformance.md)選項不會影響 **/Zc:sizedDealloc**。
...
1. 修改**其他選項**屬性，以包括 **/Zc:sizedDealloc**或 **/zc: sizeddealloc-** ，然後選擇 **確定**。
