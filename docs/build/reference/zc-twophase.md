---
title: '/Zc: twophase-（停用兩階段名稱查閱） |Microsoft Docs'
ms.custom: ''
ms.date: 03/06/2018
ms.technology:
- cpp-tools
...
如需一致性問題的詳細資訊，請參閱[在 Visual Studio 中的 c + + 一致性改善](../../cpp-conformance-improvements-2017.md)並[非標準行為](../../cpp/nonstandard-behavior.md)。
