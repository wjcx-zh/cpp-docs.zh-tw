---
title: ASCII 字元集 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-language
...
ms.locfileid: "32381118"
---
# <a name="ascii-character-set"></a>ASCII 字元集
**ANSI 2.2.1** 來源和執行字元集的成員  
  
 來源字元集是一組合法的字元，可以出現在原始程式檔中。 對於 Microsoft C 來說，來源字元集是指標準 ASCII 字元集。  
