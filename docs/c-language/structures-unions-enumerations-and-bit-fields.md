...
ms.locfileid: "62157769"
---
# <a name="structures-unions-enumerations-and-bit-fields"></a>結構、等位、列舉和位元欄位

- [不適當的聯集存取](../c-language/improper-access-to-a-union.md)

- [結構成員的填補和對齊](../c-language/padding-and-alignment-of-structure-members.md)

- [位欄位的正負號](../c-language/sign-of-bit-fields.md)

- [位元欄位的儲存](../c-language/storage-of-bit-fields.md)
