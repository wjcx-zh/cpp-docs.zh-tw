# [CRT 依字母順序排列的函式參考](crt-alphabetical-function-reference.md)
## [abort](abort.md)
...
## [assert 巨集、_assert、_wassert](assert-macro-assert-wassert.md)
## [_ASSERT、_ASSERTE、_ASSERT_EXPR 巨集](assert-asserte-assert-expr-macros.md)
...
## [Bessel 函式：_j0、_j1、_jn、_y0、_y1、_yn](bessel-functions-j0-j1-jn-y0-y1-yn.md)
## [bitand](bitand.md)
## [bitor](bitor.md)
## [bsearch](bsearch.md)
...
## [fdopen](fdopen.md)
## [_fdopen、wfdopen](fdopen-wfdopen.md)
...
## [浮點數基本](floating-point-primitives.md)
...
## [_freea](freea.md)
## f[reopen、_wfreopen](freopen-wfreopen.md)
...
## [remove0、_wremove](remove-wremove.md)
...
## [_RPT、_RPTF、_RPTW、_RPTFW 巨集](rpt-rptf-rptw-rptfw-macros.md)
...
## [_STATIC_ASSERT 巨集](static-assert-macro.md)
