...
此 POSIX 函式已遭取代。 請改用符合 ISO C++ 標準的 [_access](../../c-runtime-library/reference/access-waccess.md) 或增強安全性的 [_access_s](../../c-runtime-library/reference/access-s-waccess-s.md)。
