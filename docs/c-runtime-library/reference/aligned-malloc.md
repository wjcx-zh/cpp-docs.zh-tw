...
**_aligned_malloc**標示為 `__declspec(noalias)` 和 `__declspec(restrict)`，表示保證不會修改全域變數，而且傳回的指標沒有別名。 如需詳細資訊，請參閱 [noalias](../../cpp/noalias.md) 和 [restrict](../../cpp/restrict.md)。
