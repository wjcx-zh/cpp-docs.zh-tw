...
*pstatus*<br/>
**Fexcept_t**物件的指標，其中包含*以外*所指定的例外狀況旗標目前的值。
...
**Fegetexceptflag**函數會將*以外*所指定之浮點例外狀況狀態旗標的目前狀態儲存在*pstatus*所指向的**fexcept_t**物件中。  *pstatus*必須指向有效的**fexcept_t**物件，否則不會定義後續的行為。 **Fegetexceptflag**函式支援在 \<fenv.h 中定義的這些例外狀況宏 >：
