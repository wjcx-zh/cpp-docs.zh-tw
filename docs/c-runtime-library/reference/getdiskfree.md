...
如果此函式成功，則傳回值為零。 如果此函式失敗，則傳回值是錯誤碼。 系統會針對作業系統所傳回的任何錯誤，設定**errno**值。 如需**errno**所指示之錯誤狀況的詳細資訊，請參閱[errno 常數](../../c-runtime-library/errno-constants.md)。

## <a name="remarks"></a>備註

**_Diskfree_t**結構是以 Direct. h 定義。
