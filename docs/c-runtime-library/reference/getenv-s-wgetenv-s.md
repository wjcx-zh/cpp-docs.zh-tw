...
description: 說明 Microsoft C 執行時間連結getenv_s庫_wgetenv_s和函式。
ms.date: 4/2/2020
api_name:
- getenv_s
- _wgetenv_s
...
|*pReturnValue*|*緩衝區*|*numberOfElements*|*varname*|傳回值|
|--------------------|--------------|------------------------|---------------|------------------|
