...
**_ismbbkana**傳回非零值，如果整數*c*是片假名符號或 0，如果不是。 **_ismbbkana**會使用目前的地區設定，如地區設定相關字元的詳細資訊。 **_ismbbkana_l**完全相同，不同之處在於它會使用傳入的地區設定物件。 如需詳細資訊，請參閱 [Locale](../../c-runtime-library/locale.md)。
