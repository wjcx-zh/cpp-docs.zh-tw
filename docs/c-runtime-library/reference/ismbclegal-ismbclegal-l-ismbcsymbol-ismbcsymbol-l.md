...
|常式|測試條件|字碼頁 932 範例|
|-------------|--------------------|---------------------------|
|**_ismbclegal**|有效的多位元組|傳回的第一個位元組則為非零，才*c*是在範圍內 0x81-0x9F 或 0xE0-0xFC，而是在範圍 0x40-0x7E 或 0x80-內 FC 的第二個位元組。|
|**_ismbcsymbol**|多位元組的符號|傳回非零，才 0x8141 < =*c*< = 0x81AC。|
