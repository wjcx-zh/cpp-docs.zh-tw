...
此 POSIX 函式已遭取代。 請改用符合 ISO C++ 標準的 [_mktemp](../../c-runtime-library/reference/mktemp-wmktemp.md) 或增強安全性的 [_mktemp_s](../../c-runtime-library/reference/mktemp-s-wmktemp-s.md)。