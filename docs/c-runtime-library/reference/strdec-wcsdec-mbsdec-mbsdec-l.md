)---title:"_strdec、 _wcsdec、 _mbsdec、 _mbsdec_l |Microsoft Docs"ms.custom:""ms.date:"11/04/2016"ms.technology: [[cpp-標準-程式庫]] ms.topic: 「 參考 」 apiname: ["_wcsdec 」、 「 _strdec"、"_mbsdec"、"_mbsdec_l"] apilocation: ["msvcrt.dll"、"msvcr80.dll 」、 「 msvcr90.dll"、"msvcr100.dll 」"msvcr100_clr0400.dll"、"msvcr110.dll"、"msvcr110_clr0400.dll"、"msvcr120.dll"、"msvcr120_clr0400.dll"、"ucrtbase.dll"、"api-ms-win-crt-multibyte-l1-1-0.dll"] apitype: 「 DLLExport"f1_keywords: ["_strdec 」、 「 mbsdec_l"，"strdec"，"_mbsdec"，「 _mbsdec_l"，"mbsdec"，"wcsdec"，"_wcsdec"] dev_langs: ["c + +"] helpviewer_keywords: ["mbsdec_l 函式 」、 「 mbsdec 函式 」，「 tcsdec 函式 」，「 _tcsdec 函式 」、 「 _strdec 函式 」，「 _wcsdec 函式 」、 「 _mbsdec_l 函式 」、 「 strdec 函式 」，」wcsdec 函式 」、 「 _mbsdec 函式 」] ms.assetid: ae37c223-800f-48a9-ae8e-38c8d20af2dd author:"corob msft"ms.author:"corob"ms.workload: ["cplusplus"]
---
