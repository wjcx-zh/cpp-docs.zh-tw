...
**Strerror**函式對應*errnum*至錯誤訊息字串並傳回字串的指標。 既不**strerror**也不 **_strerror**實際上會列印訊息： 您必須為此，呼叫的輸出函式，例如[fprintf](fprintf-fprintf-l-fwprintf-fwprintf-l.md):
