...
**_mbsnset**驗證其參數; 如果*str*為 null 指標，無效參數處理常式會叫用中所述[參數驗證](../../c-runtime-library/parameter-validation.md)。 若要繼續，允許執行 **_mbsnset**傳回 NULL，且設定**errno**至**EINVAL**。 **_strnset**和 **_wcsnset**不會驗證它們的參數。
