...
如需以 x64 平臺為目標之程式碼中預設呼叫慣例的詳細資訊，請參閱[X64 呼叫慣例](../build/x64-calling-convention.md)。 如需在以 ARM 平臺為目標的程式碼中呼叫慣例問題的相關資訊，請參閱[常見的視覺C++ ARM 遷移問題](../build/common-visual-cpp-arm-migration-issues.md)。
...
|[__thiscall](../cpp/thiscall.md)|被呼叫端|推播于堆疊;**這個**指標儲存在 ECX 中|
