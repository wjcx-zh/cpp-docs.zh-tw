...
文件的這個章節包含指導方針和參考內容的 ISO 標準的 Microsoft 實作，適用於 C 和C++。

## <a name="related-articles"></a>相關文章

|標題|描述|
|-----------|-----------------|
|[歡迎回到 C++](../cpp/welcome-back-to-cpp-modern-cpp.md)|描述現代C++程式設計慣用語和最佳做法。|
|[C++ 語言參考](../cpp/cpp-language-reference.md)|參考內容的C++語言。|
|[C++ 標準程式庫](../standard-library/cpp-standard-library-reference.md)|參考內容的 Microsoft 實作的C++標準程式庫。|
