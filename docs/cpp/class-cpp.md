...
ms.locfileid: "80180972"
---
# <a name="class-c"></a>class (C++)

**Class**關鍵字會宣告類別類型，或定義類別類型的物件。
...
*declarators*<br/>
宣告子清單，指定類別類型的一個或多個執行個體名稱。 如果類別的所有資料成員都是**公用**的，宣告子可能會包含初始化運算式清單。 這在結構中更為常見，其資料成員預設是**公用**的，而不是類別中的。 如需詳細資訊，請參閱宣告子的[總覽](../cpp/overview-of-declarators.md)。
...
如需/Cli 和C++ C++/cx 中的 managed 類別和結構的詳細資訊，請參閱[類別和結構](../extensions/classes-and-structs-cpp-component-extensions.md)
