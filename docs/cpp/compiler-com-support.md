...
## <a name="microsoft-specific"></a>Microsoft 特定的  
 ...
 您可以使用[__declspec](../cpp/declspec.md)擴充的屬性[uuid](../cpp/uuid-cpp.md)指派全域唯一識別碼 (GUID) 至 COM 物件。 關鍵字[__uuidof](../cpp/uuidof-operator.md)可以用來擷取與 COM 物件相關聯的 GUID。 另一個`__declspec`屬性，[屬性](../cpp/property-cpp.md)，可用來指定**取得**並**設定**COM 物件的資料成員的方法。  
