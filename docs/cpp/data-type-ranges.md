...
|**__int16**|2|**short**、 **short int**、**帶正負號的 short int**|-32,768 到 32,767|
...
|**__int64**|8|**長**長、**帶正負**號的長長|-9,223,372,036,854,775,808 到 9,223,372,036,854,775,807|
|**unsigned __int64**|8|**不帶正負號的長長**|0 到 18,446,744,073,709,551,615|
|**bool**|1|none|**false**或**true**|
|**char**|1|none|-預設為-128 到127<br /><br /> 使用 [/J](../build/reference/j-default-char-type-is-unsigned.md) 編譯時為 0 至 255|
|**帶正負號的字元**|1|none|-128 到 127|
...
|**long long**|8|無（但相當於 **__int64**）|-9,223,372,036,854,775,808 到 9,223,372,036,854,775,807|
|**不帶正負號的長長**|8|無（但等同于不**帶正負**號的 __int64）|0 到 18,446,744,073,709,551,615|
|**enum**|視情況而定|none| |
|**float**|4|none|3.4E +/- 38 (7 位數)|
|**double**|8|none|1.7E +/- 308 (15 位數)|
|**long double**|與**double**相同|none|與**double**相同|
