...
ms.locfileid: "50553656"
---
# <a name="operator-type"></a>運算子 Type^

可以從 [Windows::UI::Xaml::Interop::TypeName](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.interop.typename.aspx) 轉換為 `Platform::Type`。
...
指定 `Platform::Type` Windows::UI::Xaml::Interop::TypeName [時，則傳回](https://msdn.microsoft.com/library/windows/apps/windows.ui.xaml.interop.typename.aspx)。
