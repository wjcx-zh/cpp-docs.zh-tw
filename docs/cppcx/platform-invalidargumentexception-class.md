---
title: 'Platform:: invalidargumentexception 類別 |Microsoft 文件'
ms.custom: ''
ms.date: 12/30/2016
...
ms.locfileid: "33086671"
---
# <a name="platforminvalidargumentexception-class"></a>Platform::InvalidArgumentException 類別
當其中一個提供給方法的引數無效時擲回。  
