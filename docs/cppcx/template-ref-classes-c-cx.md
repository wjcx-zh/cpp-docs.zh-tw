---
title: "範本 ref 類別 (C++/CX) | Microsoft Docs"
ms.custom: ""
ms.date: "01/22/2017"
...
## 撰寫 ref 類別樣板  
 下列範例示範如何將私用 ref 類別宣告為樣板，也會示範如何宣告 Standard C\+\+ 範本，以及如何將這兩個樣板同時宣告為公用 ref 類別的成員。 請注意，Standard C\+\+ 範本可由 [!INCLUDE[wrt](../cppcx/includes/wrt-md.md)]類型特製化，在本例中為 Platform::String^。  
