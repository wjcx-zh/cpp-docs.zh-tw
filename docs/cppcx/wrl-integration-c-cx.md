...
此範例中的程式碼片段取自[建置 Windows 市集應用程式論壇](http://social.msdn.microsoft.com/Forums/winappswithnativecode/thread/211ef583-db11-4e55-926b-6d9ab53dbdb4)。 此程式碼片段的作者提供下列免責聲明和條件：
