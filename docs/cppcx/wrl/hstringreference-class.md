...
名稱                                                  | 描述
----------------------------------------------------- | ----------------------------------------------------------------------------------------------
[HStringReference：： operator =](#operator-assign)       | 將另一個 `HStringReference` 物件的值移至目前的 `HStringReference` 物件。
...
第一個函式會初始化與參數*str*相同大小的新 `HStringReference` 物件。
