...
1. 獲取組合框控件的指向[CComboBox](../mfc/reference/ccombobox-class.md)物件的指標。

1. 清空下拉式方塊的所有先前內容。

1. 移動記錄集中的所有記錄,調用[CComboBox::添加](../mfc/reference/ccombobox-class.md#addstring)要添加到組合框中的當前記錄中的每個字串的 String。
