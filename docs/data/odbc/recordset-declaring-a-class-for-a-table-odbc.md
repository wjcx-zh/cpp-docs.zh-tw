...
最常見的資料錄集類別會開啟單一資料表。 若要宣告單一資料表的資料錄集類別，請使用 [加入類別] 中的 [MFC ODBC 消費者精靈](../../mfc/reference/adding-an-mfc-odbc-consumer.md)，然後透過為對應的資料錄集欄位資料成員命名的方式，選擇您想要的每個資料行。
