---
title: "使用 MFC ODBC 資料錄集 |Microsoft 文件"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
### <a name="recordset-design-and-implementation"></a>資料錄集設計和實作  
  
-   [深入了解資料錄欄位交換 (RFX)](../../data/odbc/record-field-exchange-rfx.md)  
  
-   [資料庫和資料錄集物件之間交換資料](../../data/odbc/record-field-exchange-using-rfx.md)  
...
### <a name="recordset-performance-and-convenience"></a>資料錄集的效能和方便  
  
-   [加入資料錄集的大量資料錄](../../data/odbc/recordset-adding-records-in-bulk-odbc.md)  
  
-   [篩選資料錄集的記錄](../../data/odbc/recordset-filtering-records-odbc.md)  
...
-   [執行聯結資料錄集](../../data/odbc/recordset-performing-a-join-odbc.md)  
  
-   [資料錄集中的鎖定資料錄](../../data/odbc/recordset-locking-records-odbc.md)  
...
### <a name="recordset-selection-and-sql"></a>資料錄集選取範圍和 SQL  
