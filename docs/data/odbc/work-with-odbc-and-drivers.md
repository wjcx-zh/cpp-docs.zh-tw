...
ms.locfileid: "46038785"
---
# <a name="work-with-odbc-and-drivers"></a>使用 ODBC 和驅動程式

ODBC，可讓您撰寫不依賴只有一個資料庫管理系統 (DBMS) 的應用程式。 您可以撰寫一個可操作的應用程式，您的使用者具有正確的 DBMS 特定 ODBC 驅動程式的多個 dbms。  
  
## <a name="in-this-section"></a>本節內容  
  
- [在執行階段決定 ODBC 資料來源的結構描述](../../data/odbc/data-source-determining-the-schema-of-the-data-source-odbc.md)  
  
- [取得使用 ODBC 管理員驅動程式描述](../../data/odbc/data-source-programmatically-configuring-an-odbc-data-source.md)  
