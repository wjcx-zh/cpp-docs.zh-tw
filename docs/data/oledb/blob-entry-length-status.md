...
和 `BEGIN_COLUMN_MAP` 及 `END_COLUMN_MAP` 一同使用，以繫結二進位大型物件 \([BLOB](https://msdn.microsoft.com/en-us/library/ms711511.aspx)\)。  與 [BLOB\_ENTRY](../../data/oledb/blob-entry.md) 類似，但是這個巨集也會取得 BLOB 資料行的長度與狀態。  
