---
title: CCollations、 CCollationInfo |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>備註  
 ...
 這個類別會識別出的字元定序，定義在目錄中，指定使用者可以存取。  
  
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[定序的資料列集](https://msdn.microsoft.com/en-us/library/ms715783.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
