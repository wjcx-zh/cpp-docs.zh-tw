---
title: CProcedureColumns、 CProcedureColumnInfo |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
## <a name="remarks"></a>備註  
 ...
 這個類別會傳回資訊的程序所傳回的資料列集的資料行。  
  
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[PROCEDURE_COLUMNS 資料列集](https://msdn.microsoft.com/en-us/library/ms723092.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
