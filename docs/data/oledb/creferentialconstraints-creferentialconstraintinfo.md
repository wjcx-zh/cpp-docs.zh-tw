...
## <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[REFERENTIAL_CONSTRAINTS 資料列集](https://msdn.microsoft.com/en-us/library/ms719737.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
