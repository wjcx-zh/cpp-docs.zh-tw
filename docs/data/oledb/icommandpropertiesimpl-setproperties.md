---
title: 'Icommandpropertiesimpl:: Setproperties |Microsoft 文件'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>參數  
 請參閱[icommandproperties:: Setproperties](https://msdn.microsoft.com/en-us/library/ms711497.aspx)中*OLE DB 程式設計人員參考*。  
