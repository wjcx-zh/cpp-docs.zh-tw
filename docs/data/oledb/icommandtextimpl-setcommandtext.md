---
title: 'Icommandtextimpl:: Setcommandtext |Microsoft 文件'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
#### <a name="parameters"></a>參數  
 請參閱[icommandtext:: Setcommandtext](https://msdn.microsoft.com/en-us/library/ms709757.aspx)中*OLE DB 程式設計人員參考*。  
