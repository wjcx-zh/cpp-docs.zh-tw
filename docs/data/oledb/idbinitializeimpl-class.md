...
ms.locfileid: "50081756"
---
# <a name="idbinitializeimpl-class"></a>IDBInitializeImpl 類別

提供實作[IDBInitialize](/previous-versions/windows/desktop/ms713706)介面。
...
請參閱[idbinitialize:: Initialize](/previous-versions/windows/desktop/ms718026)中*OLE DB 程式設計人員參考*。
...
請參閱[Uninitialize](/previous-versions/windows/desktop/ms719648)中*OLE DB 程式設計人員參考*。
