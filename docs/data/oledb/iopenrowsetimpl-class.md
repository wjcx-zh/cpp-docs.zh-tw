...
## <a name="remarks"></a>備註  
 [IOpenRowset](https://msdn.microsoft.com/library/ms716946.aspx)介面是必要的工作階段物件。 它會開啟，並傳回包含單一基底資料表或索引中的所有資料列的資料列集。  
  
## <a name="createrowset"></a> Iopenrowsetimpl:: Createrowset
建立資料列集物件。 不直接由使用者呼叫。 請參閱[iopenrowset:: Openrowset](https://msdn.microsoft.com/library/ms716724.aspx)在*OLE DB 程式設計人員參考。*  
 ...
 *pRowsetObj*  
 ...
 其他參數，請參閱[iopenrowset:: Openrowset](https://msdn.microsoft.com/library/ms716724.aspx)在*OLE DB 程式設計人員參考。*  
...
#### <a name="parameters"></a>參數  
 請參閱[iopenrowset:: Openrowset](https://msdn.microsoft.com/library/ms716724.aspx)中*OLE DB 程式設計人員參考*。  
