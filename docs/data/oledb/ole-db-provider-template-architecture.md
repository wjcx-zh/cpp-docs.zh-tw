---
title: OLE DB 提供者範本架構 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-data
...
下表列出必要和選用的介面，如上面所列的物件根據[OLE DB 2.6 SDK 文件](/previous-versions/windows/desktop/ms722784)。
...
[OLE DB 介面](/previous-versions/windows/desktop/ms709709)