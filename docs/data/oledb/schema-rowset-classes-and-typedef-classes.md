...
結構描述是資料庫物件所擁有，或由特定使用者已建立的集合。 目錄可以包含一或多個結構描述，但必須永遠包含稱為 INFORMATION_SCHEMA，其中包含檢視表和網域資訊結構描述的結構描述。 OLE DB 中的結構描述資訊使用預先定義的結構描述資料列集擷取，並包含型別、 資料表、 資料行、 索引、 檢視、 判斷提示和條件約束、 統計資料、 字元集，定序和網域。  
 ...
 您可以使用 typedef 類別來具現化結構描述資料列。 如下所示的相對應的 typedef 和結構描述資料列集類別。 您必須呼叫[crestrictions:: Open](../../data/oledb/crestrictions-open.md)建立結構描述資料列集的執行個體之後。 這個方法會傳回結果集，根據您指定的限制。 請參閱[IDBSchemaRowset](https://msdn.microsoft.com/library/ms713686.aspx)如需有關與每個結構描述資料列相關聯的限制資料行資訊。  
  
 下表顯示每個 OLE DB 結構描述資料列和其對應的 OLE DB 樣板 typedef 類別和資訊的類別。  
  
|OLE DB 結構描述資料列集|Typedef 類別|資訊類別|  
|--------------------------|-------------------|----------------|  
|[判斷提示](https://msdn.microsoft.com/library/ms719776.aspx)|[CAssertions](#assertion)|[CAssertionInfo](#assertion)|  
|[類別目錄](https://msdn.microsoft.com/library/ms721241.aspx)|[CCatalogs](#catalog)|[CCatalogInfo](#catalog)|  
|[CHARACTER_SETS](https://msdn.microsoft.com/library/ms722638.aspx)|[CCharacterSets](#characterset)|[CCharacterSetInfo](#characterset)|  
|[定序](https://msdn.microsoft.com/library/ms715783.aspx)|[CCollations](#collation)|[CCollationInfo](#collation)|  
...
|[資料行](https://msdn.microsoft.com/library/ms723052.aspx)|[CColumns](#columns)|[CColumnsInfo](#columns)|  
...
|[程序](https://msdn.microsoft.com/library/ms724021.aspx)|[CProcedures](#procedure)|[CProcedureInfo](#procedure)|  
...
|[結構描述](https://msdn.microsoft.com/library/ms716887.aspx)|[CSchemata](#schemata)|[CSchemataInfo](#schemata)|  
...
|[資料表](https://msdn.microsoft.com/library/ms716980.aspx)|[CTables](#table)|[CTableInfo](#table)|  
...
|[翻譯](https://msdn.microsoft.com/library/ms725365.aspx)|[CTranslations](#translation)|[CTranslationInfo](#translation)|  
...
### <a name="remarks"></a>備註  
 ...
 下表列出的類別資料成員`CAssertionInfo`及其對應 OLE DB 資料行。 請參閱[判斷提示的資料列集](https://msdn.microsoft.com/library/ms719776.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[目錄的資料列集](https://msdn.microsoft.com/library/ms721241.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[CHARACTER_SETS 資料列集](https://msdn.microsoft.com/library/ms722638.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[CHECK_CONSTRAINTS 資料列集](https://msdn.microsoft.com/library/ms712845.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[定序的資料列集](https://msdn.microsoft.com/library/ms715783.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[COLUMN_DOMAIN_USAGE 資料列集](https://msdn.microsoft.com/library/ms711240.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[COLUMN_PRIVILEGES 資料列集](https://msdn.microsoft.com/library/ms715800.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[COLUMNS 資料列集](https://msdn.microsoft.com/library/ms723052.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[CONSTRAINT_COLUMN_USAGE 資料列集](https://msdn.microsoft.com/library/ms724522.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[CONSTRAINT_TABLE_USAGE 資料列集](https://msdn.microsoft.com/library/ms724522.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[FOREIGN_KEYS 資料列集](https://msdn.microsoft.com/library/ms711276.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[INDEXES 資料列集](https://msdn.microsoft.com/library/ms709712.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[KEY_COLUMN_USAGE 資料列集](https://msdn.microsoft.com/library/ms712990.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[PRIMARY_KEYS 資料列集](https://msdn.microsoft.com/library/ms714362.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[PROCEDURE_COLUMNS 資料列集](https://msdn.microsoft.com/library/ms723092.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[PROCEDURE_PARAMETERS 資料列集](https://msdn.microsoft.com/library/ms713623.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[程序的資料列集](https://msdn.microsoft.com/library/ms724021.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[PROVIDER_TYPES 資料列集](https://msdn.microsoft.com/library/ms709785.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
|m_nSearchable|可搜尋|  
|m_bUnsignedAttribute|UNSIGNED_ATTRIBUTE 設|  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[REFERENTIAL_CONSTRAINTS 資料列集](https://msdn.microsoft.com/library/ms719737.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[結構描述資料列集](https://msdn.microsoft.com/library/ms716887.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[SQL_LANGUAGES 資料列集](https://msdn.microsoft.com/library/ms714374.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[統計資料資料列集](https://msdn.microsoft.com/library/ms715957.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[TABLE_CONSTRAINTS 資料列集](https://msdn.microsoft.com/library/ms715921.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[TABLE_PRIVILEGES 資料列集](https://msdn.microsoft.com/library/ms725428.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[TABLES 資料列集](https://msdn.microsoft.com/library/ms716980.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[翻譯的資料列集](https://msdn.microsoft.com/library/ms725365.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[USAGE_PRIVILEGES 資料列集](https://msdn.microsoft.com/library/ms722743.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[VIEW_COLUMN_USAGE 資料列集](https://msdn.microsoft.com/library/ms714896.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[檢視資料列集](https://msdn.microsoft.com/library/ms723122.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
...
### <a name="remarks"></a>備註  
 ...
 下表列出類別資料成員和其相對應的 OLE DB 資料行。 請參閱[VIEW_TABLE_USAGE 資料列集](https://msdn.microsoft.com/library/ms719727.aspx)中*OLE DB 程式設計人員參考*如需有關結構描述和資料行。  
