...
此程式碼取自[UpdatePV](https://github.com/Microsoft/VCSamples/tree/master/VC2010Samples/ATL/OLEDB/Provider/UPDATEPV)範例。 `UpdatePv` 支援三個必要的結構描述資料列集： DBSCHEMA_TABLES、 DBSCHEMA_COLUMNS 和 DBSCHEMA_PROVIDER_TYPES。 如何在您的提供者中實作結構描述支援的範例，本主題引導您實作 DBSCHEMA_TABLE 資料列集。
