---
title: 'deque:: empty (STL/CLR) |Microsoft 文件'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-cli
...
## <a name="remarks"></a>備註  
 成員函式會對空的受控制序列傳回 true。 它相當於[deque:: size (STL/CLR)](../dotnet/deque-size-stl-clr.md)`() == 0`。 您可以使用它來測試是否 deque 為空白。  
