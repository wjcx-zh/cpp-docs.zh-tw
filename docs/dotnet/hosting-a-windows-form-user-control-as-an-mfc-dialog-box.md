...
4.  新增`#include <afxwinforms.h>`至 stdafx.h 中結尾的現有`#include`陳述式。  
  
5.  加入新的類別子類別化`CDialog`。  
...
6.  取代`CDialog`CHostForWinForm.h 和 CHostForWinForm.cpp 檔案中`CWinFormsDialog<WindowsControlLibrary1::UserControl1>`。  
