---
title: 如何： 使用 PInvoke 的 Managed 程式碼呼叫原生 Dll |Microsoft Docs
...
## <a name="example"></a>範例  
 下列程式碼範例會使用 Win32 [GetSystemMetrics](https://msdn.microsoft.com/library/windows/desktop/ms724385)函式來擷取目前像素為單位的螢幕解析度。  
