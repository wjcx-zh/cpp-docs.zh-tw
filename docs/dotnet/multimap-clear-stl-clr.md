...
## 備註  
 成員函式有效地呼叫 [multimap::erase](../dotnet/multimap-erase-stl-clr.md)`(` [multimap::begin](../dotnet/multimap-begin-stl-clr.md)`(),` [multimap::end](../dotnet/multimap-end-stl-clr.md)`())`。  您會用它來確保受控制序列是空的。  
