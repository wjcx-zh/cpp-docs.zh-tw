...
ms.locfileid: "34704824"
---
# <a name="pure-and-verifiable-code-ccli"></a>純粹的和可驗證的程式碼 (C + + /CLI)

對於.NET 程式設計，Visual c + + 在 Visual Studio 2017 支援混合的組件建立使用[/clr （Common Language Runtime 編譯）](../build/reference/clr-common-language-runtime-compilation.md)編譯器選項。 **/Clr: pure**和 **: safe**選項都是 Visual Studio 2015 中已被取代，並在 Visual Studio 2017 中支援。 如果您的程式碼必須是安全或驗證，我們建議您將其移植到 C#。
