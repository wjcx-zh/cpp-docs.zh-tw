...
> [!NOTE]
> MFC Windows Form 整合只適用於使用 MFC 動態連結的專案 (專案所在`_AFXDLL`定義)。
...
使用 Windows Form 應用程式的範例，請參閱[BirthdayPicker 範例： 使用 Windows Form 示範.NET Framework 資源](http://msdn.microsoft.com/ac932aed-5502-4667-be29-709bca435317)，[計算機範例： Windows Form Pocket 計算機](http://msdn.microsoft.com/2283b516-3b7e-45f2-80c4-fdcfb366ce25)，和[Scribble 範例： MDI 繪圖應用程式](http://msdn.microsoft.com/f025da3e-659b-4222-b991-554a1b8b2358)。
...
如果您的 MFC 應用程式使用 Windows Form，您需要重新發佈 mfcmifc80.dll 與您的應用程式。 如需詳細資訊，請參閱[轉散發 MFC 程式庫](../ide/redistributing-the-mfc-library.md)。
