...
|[編譯器錯誤 C2219](compiler-error-c2219.md)|語法錯誤： 類型限定詞必須在之後 ' *'|
...
|[編譯器錯誤 C2252](compiler-error-c2252.md)|樣板的明確具現化只能在命名空間範圍|
...
|[編譯器錯誤 C2298](compiler-error-c2298.md)|遺漏繫結至成員函式的指標呼叫|
