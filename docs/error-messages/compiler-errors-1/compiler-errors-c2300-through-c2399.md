...
|[編譯器錯誤 C2307](compiler-error-c2307.md)|pragma*指示詞*如果啟用累加編譯，則必須移動函式以外|
|[編譯器錯誤 C2308](compiler-error-c2308.md)|將不相符的字串串連|
|[編譯器錯誤 C2309](compiler-error-c2309.md)|catch 處理常式必須在括號括住例外狀況宣告|
|[編譯器錯誤 C2310](compiler-error-c2310.md)|catch 處理常式必須指定一個類型|
|[編譯器錯誤 C2311](compiler-error-c2311.md)|'*型別*': '...' 在行被攔截*數目*|
|[編譯器錯誤 C2312](compiler-error-c2312.md)|'*type1*': 攔截到'*type2*' 該行*數目*|
|[編譯器錯誤 C2313](compiler-error-c2313.md)|'*type1*': 參考被攔截 ('*type2*') 該行*數目*|
|編譯器錯誤 C2314|關鍵字 '*keyword1*' 已被取代： 使用 '*keyword2*' 改為|
|[編譯器錯誤 C2315](compiler-error-c2315.md)|'*type1*': 參考被攔截'*type2*' 該行*數目*|
|[編譯器錯誤 C2316](compiler-error-c2316.md)|'*型別*': 無法攔截，因為解構函式及/或複製建構函式無法存取或已刪除|
|[編譯器錯誤 C2317](compiler-error-c2317.md)|'try' 區塊開始於行 '*數字*' 沒有 catch 處理常式|
...
|[編譯器錯誤 C2322](compiler-error-c2322.md)|'*識別碼*': dllimport 的位址'*識別項*' 不是靜態|
|編譯器錯誤 C2323|'*識別碼*': 非成員運算子 new 或 delete 函式不可以宣告靜態或全域命名空間以外的命名空間|
|[編譯器錯誤 C2324](compiler-error-c2324.md)|'*識別碼*': 非預期的右邊 ':: ~'|
|[編譯器錯誤 C2325](compiler-error-c2325.md)|'*type1*': 非預期的類型，右邊的'-> ~': 必須是 '*type2*'|
|[編譯器錯誤 C2326](compiler-error-c2326.md)|'*declarator*': 函式無法存取'*識別項*'|
...
|[編譯器錯誤 C2334](compiler-error-c2334.md)|未預期有語彙基元上述 '*語彙基元*'; 略過函式主體|
|編譯器錯誤 C2335|'*識別碼*': 類型不能引入函式參數清單|
|編譯器錯誤 C2336|'*型別*': 不合法的類型|
...
|[編譯器錯誤 C2356](compiler-error-c2356.md)|初始設定區段不可以變更在轉譯單位|
|[編譯器錯誤 C2357](compiler-error-c2357.md)|'*識別碼*': 必須是類型的函式'*型別*'|
...
|[編譯器錯誤 C2364](compiler-error-c2364.md)|'*型別*': 對自訂屬性的類型不合法|
...
|[編譯器錯誤 C2370](compiler-error-c2370.md)|'*識別碼*': 重複定義; 不同的儲存體類別|
|[編譯器錯誤 C2371](compiler-error-c2371.md)|'*識別碼*': 重複定義; 不同的基本類型|
...
|[編譯器錯誤 C2386](compiler-error-c2386.md)|'*識別碼*': 目前的範圍中已經有使用此名稱的符號|
