...
|[嚴重錯誤 C1016](fatal-error-c1016.md)|#ifdef/#ifndef 必須是識別項|
|[嚴重錯誤 C1017](../../error-messages/compiler-errors-1/fatal-error-c1017.md)|無效的整數常數運算式|
|[嚴重錯誤 C1018](fatal-error-c1018.md)|未預期的 #elif|
|[嚴重錯誤 C1019](fatal-error-c1019.md)|未預期的 #else|
|[嚴重錯誤 C1020](fatal-error-c1020.md)|未預期的 #endif|
|[嚴重錯誤 C1021](fatal-error-c1021.md)|無效的前置處理器命令 '*string*'|
|[嚴重錯誤 C1022](fatal-error-c1022.md)|需要對應的 #endif|
|[嚴重錯誤 C1023](fatal-error-c1023.md)|'*file*': pch 發生未預期的錯誤，請嘗試重建 pch|
...
|[嚴重錯誤 C1035](fatal-error-c1035.md)|運算式太複雜; 請簡化運算式|
|嚴重錯誤 C1036|無法覆寫舊版的程式資料庫格式，刪除 '*file*' 並重新編譯|
|[嚴重錯誤 C1037](fatal-error-c1037.md)|無法開啟目的檔 '*file*'|
|[嚴重錯誤 C1038](fatal-error-c1038.md)|編譯器限制: '*function*': 控制流程狀態太複雜; 請簡化函式|
|嚴重錯誤 C1041|無法開啟程式資料庫 '*file*'; 如果要將多個 CL.EXE 寫到同一個 .PDB 檔案，請使用 /FS|
|[嚴重錯誤 C1045](fatal-error-c1045.md)|編譯器限制: 連結規格巢狀結構太深|
...
|[嚴重錯誤 C1091](fatal-error-c1091.md)|編譯器限制: 字串長度超過 *number* 個位元組的上限|
...
|[嚴重錯誤 C1208](fatal-error-c1208.md)|所安裝的執行階段版本不支援在堆疊上配置參考類別|
