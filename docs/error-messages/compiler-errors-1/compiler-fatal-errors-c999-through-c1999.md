...
|[嚴重錯誤 C1001](../../error-messages/compiler-errors-1/fatal-error-c1001.md)|編譯器中發生內部錯誤。<br /><br /> (編譯器檔案 '*檔案*'，行*數目*)<br /><br /> 若要解決這個問題，請嘗試簡化或變更上面所列位置附近的程式。 請選擇 Visual C++ [說明] 功能表上的 [技術支援] 命令或開啟技術支援說明檔以取得詳細資訊|  
|[嚴重錯誤 C1002](../../error-messages/compiler-errors-1/fatal-error-c1002.md)|編譯器於第二編譯階段堆積空間不足|  
|[嚴重錯誤 C1003](../../error-messages/compiler-errors-1/fatal-error-c1003.md)|錯誤計數超過*數目*; 停止編譯|  
|[嚴重錯誤 C1004](../../error-messages/compiler-errors-1/fatal-error-c1004.md)|找到未預期的檔案結尾|  
|[嚴重錯誤 C1005](../../error-messages/compiler-errors-1/fatal-error-c1005.md)|字串太大超過緩衝區|  
...
|嚴重錯誤 C1021|無效的前置處理器命令 '*字串*'|  
|嚴重錯誤 C1022|需要對應的 #endif|  
|嚴重錯誤 C1023|'*檔案*': 未預期的錯誤 pch，請嘗試重建 pch|  
|[嚴重錯誤 C1026](../../error-messages/compiler-errors-1/fatal-error-c1026.md)|剖析器堆疊溢位，程式太複雜|  
|[嚴重錯誤 C1033](../../error-messages/compiler-errors-1/fatal-error-c1033.md)|無法開啟程式資料庫 '*檔案*'|  
|嚴重錯誤 C1034|*檔案*︰ 沒有設定 include 路徑|  
|嚴重錯誤 C1035|運算式太複雜; 請簡化運算式|  
|嚴重錯誤 C1036|無法覆寫舊版的程式資料庫格式，刪除 '*檔案*' 並重新編譯|  
|嚴重錯誤 C1037|無法開啟目的檔 '*檔案*'|  
|嚴重錯誤 C1038|編譯器限制: '*函式*': 控制流程狀態太複雜; 請簡化函式|  
...
|嚴重錯誤 C1068|無法開啟檔案 '*檔案*'|  
|嚴重錯誤 C1069|無法讀取編譯器命令列|  
|嚴重錯誤 C1070|不相符的 #if / #endif 組合檔案中 '*檔案*'|  
|[嚴重錯誤 C1071](../../error-messages/compiler-errors-1/fatal-error-c1071.md)|在註解中找到未預期的檔案結尾|  
|[嚴重錯誤 C1073](../../error-messages/compiler-errors-1/fatal-error-c1073.md)|累加編譯時發生內部錯誤 (編譯器檔案 '*檔案*'，行*數目*)|  
|嚴重錯誤 C1074|'IDB' 是不合法的延伸模組的 PDB 檔案︰*檔案*|  
|[嚴重錯誤 C1075](../../error-messages/compiler-errors-1/fatal-error-c1075.md)|左邊*語彙基元*檔案結尾處不相符|  
|[嚴重錯誤 C1076](../../error-messages/compiler-errors-1/fatal-error-c1076.md)|編譯器限制: 已達到內部堆積上限; 請改用 /Zm 指定更高的上限|  
|嚴重錯誤 C1077|編譯器限制︰ 不能有多個*數目*命令列選項|  
|[嚴重錯誤 C1079](../../error-messages/compiler-errors-1/fatal-error-c1079.md)|編譯器限制: 超過 PCH 檔案大小上限|  
|[嚴重錯誤 C1080](../../error-messages/compiler-errors-1/fatal-error-c1080.md)|編譯器限制︰ 命令列選項超過限制的*數目*字元|  
|[嚴重錯誤 C1081](../../error-messages/compiler-errors-1/fatal-error-c1081.md)|'*檔案*': 檔名太長|  
|嚴重錯誤 C1082|無法關閉*類型*檔案: '*檔案*':*訊息*|  
|[嚴重錯誤 C1083](../../error-messages/compiler-errors-1/fatal-error-c1083.md)|無法開啟*類型*檔案: '*檔案*':*訊息*|  
|[嚴重錯誤 C1084](../../error-messages/compiler-errors-1/fatal-error-c1084.md)|無法讀取*類型*檔案: '*檔案*':*訊息*|  
|[嚴重錯誤 C1085](../../error-messages/compiler-errors-1/fatal-error-c1085.md)|無法寫入*類型*檔案: '*檔案*':*訊息*|  
|嚴重錯誤 C1086|無法搜尋*類型*檔案: '*檔案*':*訊息*|  
|嚴重錯誤 C1087|無法分辨*類型*檔案: '*檔案*':*訊息*|  
|嚴重錯誤 C1088|無法排清*類型*檔案: '*檔案*':*訊息*|  
|嚴重錯誤 C1089|無法截斷*類型*檔案: '*檔案*':*訊息*|  
|嚴重錯誤 C1090|PDB API 呼叫失敗，錯誤碼 '*程式碼*':'*訊息*'|  
|嚴重錯誤 C1091|編譯器限制︰ 字串超過*數目*位元組的長度|  
|[嚴重錯誤 C1092](../../error-messages/compiler-errors-1/fatal-error-c1092.md)|編輯後繼續不支援對資料類型的變更; 需要先進行建置|  
|[嚴重錯誤 C1093](../../error-messages/compiler-errors-1/fatal-error-c1093.md)|API 呼叫 '*函式*「 失敗 」*HRESULT*':'*描述*'|  
|[嚴重錯誤 C1094](../../error-messages/compiler-errors-1/fatal-error-c1094.md)|'-Zm*數目*': 命令列選項不一致，用來建置先行編譯標頭的值 ('-Zm*數目*')|  
|嚴重錯誤 C1098|版本與編輯後繼續程式引擎不符|  
|嚴重錯誤 C1099|編輯後繼續程式引擎正在終止編譯|  
|嚴重錯誤 C1100|無法初始化 OLE:*錯誤*|  
|嚴重錯誤 C1101|無法建立屬性的處理常式 '*識別碼*'|  
|嚴重錯誤 C1102|無法初始化︰*錯誤*|  
|嚴重錯誤 C1103|嚴重錯誤匯入 progid: '*訊息*'|  
|嚴重錯誤 C1104|匯入 libid 時發生嚴重錯誤: '*訊息*'|  
|嚴重錯誤 C1105|*訊息*:*錯誤*|  
|[嚴重錯誤 C1107](../../error-messages/compiler-errors-1/fatal-error-c1107.md)|找不到組件 '*組件*': 請指定組件搜尋路徑，請使用 /AI 或設定 LIBPATH 環境變數|  
|嚴重錯誤 C1108|找不到 DLL: '*檔案*'|  
|嚴重錯誤 C1109|找不到 '*符號*'在 DLL'*檔案*'|  
...
|[嚴重錯誤 C1197](../../error-messages/compiler-errors-1/fatal-error-c1197.md)|無法參考 '*檔案*'as 程式已經參考'*檔案*'|  
|嚴重錯誤 C1201|類別樣板定義中發生語法錯誤，無法繼續|  
|嚴重錯誤 C1202|遞迴類型或函式相依內容太複雜|  
|嚴重錯誤 C1205|所安裝的執行階段版本不支援泛型|  
|嚴重錯誤 C1206|所安裝的執行階段版本不支援 Per-appdomain 資料|  
|嚴重錯誤 C1207|所安裝的執行階段版本不支援 Managed 樣板|  
|嚴重錯誤 C1208|所安裝的執行階段版本不支援在堆疊上配置參考類別|  
|嚴重錯誤 C1209|所安裝的執行階段版本不支援 Friend 組件|  
|嚴重錯誤 C1210|所安裝的執行階段版本不支援 /clr:pure 和 /clr:safe|  
|嚴重錯誤 C1211|所安裝的 執行階段版本不支援 TypeForwardedTo 自訂屬性|  
|嚴重錯誤 C1300|存取程式資料庫時發生錯誤*檔案*(*訊息*)|  
|嚴重錯誤 C1301|存取程式資料庫時發生錯誤*檔案*、 無效的格式，請刪除後重建|  
|嚴重錯誤 C1302|模組的設定檔資料不 '*模組*'在於分析資料庫'*檔案*'|  
|[嚴重錯誤 C1305](../../error-messages/compiler-errors-1/fatal-error-c1305.md)|分析資料庫 '*檔案*' 適用於不同的架構|  
|嚴重錯誤 C1306|上次變更分析資料基底 '*檔案*' 不是最佳化分析; 最佳化決策可能已經過期|  
|[嚴重錯誤 C1307](../../error-messages/compiler-errors-1/fatal-error-c1307.md)|在收集分析資料時已對程式進行編輯|  
|[嚴重錯誤 C1308](../../error-messages/compiler-errors-1/fatal-error-c1308.md)|*檔案*︰ 不支援連結組件|  
|[嚴重錯誤 C1309](../../error-messages/compiler-errors-1/fatal-error-c1309.md)|C2 的版本不相符。DLL 和 pgodb*ver*。DLL|  
|嚴重錯誤 C1310|特性指引最佳化不適用於 OpenMP|  
|[嚴重錯誤 1311](../../error-messages/compiler-errors-1/fatal-error-c1311.md)|COFF 格式無法以靜態方式初始化 '*符號*' 與*數目*位元組的地址|  
|嚴重錯誤 C1312|函式中的條件式分支太多。  請簡化或重整原始程式碼。|  
|[嚴重錯誤 C1313](../../error-messages/compiler-errors-1/fatal-error-c1313.md)|編譯器限制︰*類型*區塊巢狀深度比*數目*層級|  
|[嚴重錯誤 C1350](../../error-messages/compiler-errors-1/fatal-error-c1350.md)|載入 dll 時發生錯誤 '*檔案*': 找不到 dll|  
|[嚴重錯誤 C1351](../../error-messages/compiler-errors-1/fatal-error-c1351.md)|載入 dll 時發生錯誤 '*檔案*': 不相容版本|  
|嚴重錯誤 C1352|在函式的 MSIL 無效或損毀 '*函式*'從模組'*模組*'|  
|嚴重錯誤 C1353|中繼資料作業失敗: 未安裝執行階段或版本不符|  
|[嚴重錯誤 C1382](../../error-messages/compiler-errors-1/fatal-error-c1382.md)|PCH 檔案 '*檔案*'後，已重建'*obj*' 所產生。 請重建此物件|  
|嚴重錯誤 C1383|編譯器選項 /GL 與所安裝 Common Language Runtime 的版本不相容|  
|嚴重錯誤 C1384|在連結時，PGO_PATH_TRANSLATION 的設定 '*檔案*'|  
|嚴重錯誤 C1451|產生偵錯資訊編譯呼叫圖表 parallel_for_each 時失敗: '*callsite*'|  
|嚴重錯誤 C1505|無法回復的剖析器前查詢錯誤|  
|[嚴重錯誤 C1506](../../error-messages/compiler-errors-1/fatal-error-c1506.md)|無法回復的區塊範圍錯誤|  
|嚴重錯誤 C1508|編譯器限制: '*函式*': 引數超過 65535 的位元組|  
|[嚴重錯誤 C1509](../../error-messages/compiler-errors-1/fatal-error-c1509.md)|編譯器限制︰ 函式中的例外狀況處理常式狀態太多 '*函式*'; 請簡化函式|  
...
|[嚴重錯誤 C1603](../../error-messages/compiler-errors-1/fatal-error-c1603.md)|內嵌組譯碼分支目標超過範圍*數目*位元組|  
|嚴重錯誤 C1852|'*檔案*' 不是有效的先行編譯標頭檔|  
|[嚴重錯誤 C1853](../../error-messages/compiler-errors-1/fatal-error-c1853.md)|'*檔案*' 先行編譯標頭檔來自較舊版本的編譯器，或者先行編譯標頭是 c + +，而先使用自 C （反之亦然）|  
|[嚴重錯誤 C1854](../../error-messages/compiler-errors-1/fatal-error-c1854.md)|無法覆寫在目的檔中先行編譯標頭建立期間形成的資訊: '*檔案*'|  
|[嚴重錯誤 C1900](../../error-messages/compiler-errors-1/fatal-error-c1900.md)|之間的 Il 不符 '*工具*'version'*數目*'和'*工具*'version'*數目*'|  
|嚴重錯誤 C1901|內部記憶體管理錯誤|  
|[嚴重錯誤 C1902](../../error-messages/compiler-errors-1/fatal-error-c1902.md)|程式資料庫管理員不相符; 請檢查您的安裝|  
|嚴重錯誤 C1903|無法從先前的錯誤復原; 正在停止編譯|  
|嚴重錯誤 C1904|錯誤的提供者互動: '*檔案*'|  
