...
|[嚴重錯誤 C1007](../../error-messages/compiler-errors-1/fatal-error-c1007.md)|無法辨認 '`string`' 中的旗標 '`option`'|  
...
|[嚴重錯誤 C1010](../../error-messages/compiler-errors-1/fatal-error-c1010.md)|尋找先行編譯的標頭時出現非預期的檔案結尾。 您忘記新增 ' #include <`file`>' 到您的來源嗎？|  
...
|[嚴重錯誤 C1033](../../error-messages/compiler-errors-1/fatal-error-c1033.md)|無法開啟程式資料庫 '`file`'|  
|嚴重錯誤 C1034|`file`: 沒有設定 Include 路徑|  
|嚴重錯誤 C1035|運算式太複雜; 請簡化運算式|  
|嚴重錯誤 C1036|無法覆寫舊版的程式資料庫格式，刪除 '`file`' 並重新編譯|  
|嚴重錯誤 C1037|無法開啟目的檔 '`file`'|  
|嚴重錯誤 C1038|編譯器限制: '`function`': 控制流程狀態太複雜; 請簡化函式|  
...
|嚴重錯誤 C1048|'`string`' 中有未知的選項 '`option`'|  
...
|嚴重錯誤 C1109|在 DLL '`symbol`' 中找不到 '`file`'|  
|嚴重錯誤 C1110|太多巢狀範本/泛型定義|  
|嚴重錯誤 C1111|太多範本/泛型參數|  
|嚴重錯誤 C1112|編譯器限制: ' `'number`' 的巨集引數太多，僅允許 `number` 個|  
|[嚴重錯誤 C1113](../../error-messages/compiler-errors-1/fatal-error-c1113.md)|#使用無法在 '`file`'|  
...
|[嚴重錯誤 C1189](../../error-messages/compiler-errors-1/fatal-error-c1189.md)|#錯誤︰`message`|  
|嚴重錯誤 C1190|Managed 目標程式碼需要 '/clr' 選項|  
|[嚴重錯誤 C1191](../../error-messages/compiler-errors-1/fatal-error-c1191.md)|只能在全域範圍匯入 '`file`'|  
|[嚴重錯誤 C1192](../../error-messages/compiler-errors-1/fatal-error-c1192.md)|#使用無法在 '`file`'|  
...
|[嚴重錯誤 C1311](../../error-messages/compiler-errors-1/fatal-error-c1311.md)|COFF 格式無法以靜態方式初始化 '`symbol`' (位址為 `number` 個位元組)|  
...
|[嚴重錯誤 C1382](../../error-messages/compiler-errors-1/fatal-error-c1382.md)|自從產生 '`file`' 後，已重建 PCH 檔案 '`obj`'。 請重建此物件|  
