...
1. 如果您是在 64 位元平台上編譯，請使用 64 位元編譯器工具組。 如需相關資訊，請參閱[如何：啟用 64 位元視覺效果C++命令列上的工具組](../../build/how-to-enable-a-64-bit-visual-cpp-toolset-on-the-command-line.md)。
