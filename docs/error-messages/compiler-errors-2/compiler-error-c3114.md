...
如需詳細資訊，請參閱 <<c0> [ 屬性](../../windows/property-cpp-component-extensions.md)並[User-Defined Attributes](../../windows/user-defined-attributes-cpp-component-extensions.md)。
