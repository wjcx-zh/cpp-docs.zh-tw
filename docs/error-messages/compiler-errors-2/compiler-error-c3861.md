...
如果錯誤 c3861： 從較舊版本的編譯器中會出現專案移轉之後，您可能必須支援的 Windows 版本相關問題。 Visual C++ 不再支援將 Windows 95、Windows 98、Windows ME、Windows NT 或 Windows 2000 當做目標。 如果您的 **WINVER** 或 **_WIN32_WINNT** 巨集指派給其中一個這些 Windows 版本中，您必須修改巨集。 如需詳細資訊，請參閱[修改 WINVER 和 _WIN32_WINNT](../../porting/modifying-winver-and-win32-winnt.md)。
...
### <a name="identifier-not-in-scope"></a>不在範圍的識別項
...
### <a name="namespace-qualification-required"></a>命名空間所需的限定性條件
