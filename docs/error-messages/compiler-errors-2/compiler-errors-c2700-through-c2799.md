...
|[編譯器錯誤 C2712](compiler-error-c2712.md)|無法在中使用 __try 需要物件回溯函式|
...
|[編譯器錯誤 C2776](compiler-error-c2776.md)|每個屬性，可以指定只能有一個 'get' 方法|
|[編譯器錯誤 C2777](compiler-error-c2777.md)|每個屬性，可以指定只能有一個 'put' 方法|
|[編譯器錯誤 C2778](compiler-error-c2778.md)|uuid 的格式不正確的 GUID|
...
|[編譯器錯誤 C2790](compiler-error-c2790.md)|'super': 此關鍵字只用於類別成員函式主體內|
