---
title: 編譯器錯誤 C3000 到 C3099 |Microsoft Docs
ms.custom: ''
ms.date: 11/17/2017
ms.technology:
- cpp-diagnostics
...
|[編譯器錯誤 C3007](compiler-error-c3007.md)|'*子句*': 子句在 OpenMP'*指示詞*' 指示詞不會不接受引數|
|[編譯器錯誤 C3008](compiler-error-c3008.md)|*引數*': 引數遺漏右 ')' 在 OpenMP '*指示詞*' 指示詞|
|[編譯器錯誤 C3009](compiler-error-c3009.md)|'*標籤*': 跳入 OpenMP 結構化區塊，不允許|
|[編譯器錯誤 C3010](compiler-error-c3010.md)|'*標籤*': 跳出 OpenMP 結構化區塊，不允許|
...
|[編譯器錯誤 C3014](compiler-error-c3014.md)|必須是 for 迴圈遵循 OpenMP '*指示詞*' 指示詞|
...
|[編譯器錯誤 C3023](compiler-error-c3023.md)|'*引數*': OpenMP 引數中發現未預期的 token'*指示詞*' 子句|
...
|[編譯器錯誤 C3027](compiler-error-c3027.md)|'*子句*': 必須是算術或指標運算式|
|[編譯器錯誤 C3028](compiler-error-c3028.md)|'*成員*': 只有變數或靜態資料成員可用的資料共用子句中|
...
|[編譯器錯誤 C3032](compiler-error-c3032.md)|'*識別碼*': 變數'*子句*'子句不能有不完整類型'*型別*'|
...
|[編譯器錯誤 C3037](compiler-error-c3037.md)|'*識別碼*': 變數'*子句*' 子句必須共用的封入內容中|
|[編譯器錯誤 C3038](compiler-error-c3038.md)|'*識別碼*': 'private' 子句中的變數不可為削減變數封入內容中|
|[編譯器錯誤 C3039](compiler-error-c3039.md)|'*識別碼*': 在 OpenMP 'for' 陳述式的索引變數不可為削減變數|
|[編譯器錯誤 C3040](compiler-error-c3040.md)|'*識別碼*': 'reduction' 子句中的變數的類型與削減運算子不相容'*運算子*'|
...
|[編譯器錯誤 C3050](compiler-error-c3050.md)|'*類別*': ref 類別不可繼承自'*識別項*'|
|編譯器錯誤 C3051|已過時。|
...
|[編譯器錯誤 C3055](compiler-error-c3055.md)|'*識別碼*': 'threadprivate' 指示詞中使用之前，不能參考符號|
|[編譯器錯誤 C3056](compiler-error-c3056.md)|'*識別碼*': 符號不是在相同範圍和 'threadprivate' 指示詞|
...
|[編譯器錯誤 C3059](compiler-error-c3059.md)|'*識別碼*': 'threadprivate' 符號不能在'*子句*' 子句|
|[編譯器錯誤 C3060](compiler-error-c3060.md)|'*識別碼*': friend 函式未在使用限定的名稱 （它只可以宣告） 在類別定義|
|編譯器錯誤 C3061|運算子 '*運算子*': 不允許用於列舉型別'*型別*'與基礎類型'*型別*'|
|[編譯器錯誤 C3062](compiler-error-c3062.md)|'*識別碼*': 列舉值需要值，因為基礎類型為'*型別*'|
|[編譯器錯誤 C3063](compiler-error-c3063.md)|運算子 '*運算子*': 所有運算元必須都具有相同的列舉類型|
|編譯器錯誤 C3064|'*識別碼*': 必須是簡單型別，或者可解析|
...
|[編譯器錯誤 C3072](compiler-error-c3072.md)|運算子 '*運算子*' 無法套用至 ref 類別使用一元 '%' 運算子，以轉換執行個體的 ref 類別控制代碼類型的執行個體|
|[編譯器錯誤 C3073](compiler-error-c3073.md)|'*識別碼*': ref 類別沒有使用者定義的複製建構函式|
|編譯器錯誤 C3074|無法使用括號括住的初始設定式初始化陣列|
|[編譯器錯誤 C3075](compiler-error-c3075.md)|'*識別碼*': 您無法內嵌執行個體的參考類型，'*型別*'，在實值類型|
|[編譯器錯誤 C3076](compiler-error-c3076.md)|'*識別碼*': 您無法內嵌執行個體的參考類型，'*型別*'，原生類型中|
|[編譯器錯誤 C3077](compiler-error-c3077.md)|'*識別碼*': 完成項只能是參考類型的成員|
|編譯器錯誤 C3078|必須在新的運算式中指定陣列大小|
|編譯器錯誤 C3079|初始設定式清單不能為此指派運算子的右運算元|
...
|[編譯器錯誤 C3085](compiler-error-c3085.md)|'*識別碼*': 建構函式不可為'*關鍵字*'|
|編譯器錯誤 C3086|找不到 'std:: initializer_list': 您需要 #include \<initializer_list >|
|[編譯器錯誤 C3087](compiler-error-c3087.md)|'*識別碼*': 呼叫的'*宣告*' 已經初始化這個成員|
|編譯器錯誤 C3088|'*類別*': 屬性建構函式必須有具名型式引數|
|編譯器錯誤 C3089|'*識別碼*': 參數名稱不符合任何資料成員的名稱|
|編譯器錯誤 C3090|'*類別*': 屬性類別不可為樣板|
|編譯器錯誤 C3091|'*類別*': 屬性類別不可擁有基底類別|
|編譯器錯誤 C3092|'*類別*': 屬性類別成員不可為位元欄位、 'static' 或 'const'|
|編譯器錯誤 C3093|'*型別*': 不允許屬性類別成員的類型'*成員*'|
|[編譯器錯誤 C3094](compiler-error-c3094.md)|'*屬性*': 不允許匿名使用|
|[編譯器錯誤 C3095](compiler-error-c3095.md)|'*屬性*': 屬性不可以重複|
