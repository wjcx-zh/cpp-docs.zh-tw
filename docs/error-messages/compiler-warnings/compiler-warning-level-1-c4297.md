...
ms.locfileid: "73626637"
---
# <a name="compiler-warning-level-1-c4297"></a>編譯器警告（層級1） C4297
...
標記為 extern "C" 的 __declspec （[dllexport](../../cpp/dllexport-dllimport.md)）函式也會產生這個警告，即使它們C++是函式也一樣。
