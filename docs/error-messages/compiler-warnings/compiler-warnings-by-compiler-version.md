...
編譯器可以隱藏導入後的版本，您可以使用指定的警告[/Wv](../../build/reference/compiler-option-warning-level.md)編譯器選項。 這是適合用來管理您的建置程序，當您引入新的工具組版本，並想要暫時隱藏新的警告。 這個選項不會隱藏新的錯誤訊息。 我們不建議您隱藏所有的新警告永久 ！ 我們建議您一律在最高規則的警告層級編譯__/W4__，並移除__/Wv__儘速在您的組建選項。  
...
您可以指定只有主要版本號碼、 主要和次要的數字或主要、 次要、 和組建編號__/Wv__選項，隱藏所有警告。 版本大於指定的數目。 例如，若要隱藏在 Visual c + + 2015 Update 2 和更新版本導入的警告，您可以使用__/Wv:19.00.23900__。 若要隱藏所有警告，在 Visual c + + 2013年和更新版本，您可以使用__/Wv:18__。  
  
下列章節會列出您可以藉由使用隱藏的 Visual c + + 的每個版本所導入的警告__/Wv__編譯器選項。 __/Wv__選項無法隱藏警告不會列出，自封指定的版本的編譯器。
  
## <a name="warnings-introduced-in-visual-c-2017-update-1"></a>Visual c + + 2017 Update 1 中導入的警告
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19.10.25000__。  
...
## <a name="warnings-introduced-in-visual-c-2017-rtm"></a>在 Visual c + + 2017 RTM 中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19.10__。  
...
## <a name="warnings-introduced-in-visual-c-2015-update-3"></a>在 Visual c + + 2015 Update 3 引入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19.00.24000__。  
...
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19.00.23900__。  
...
## <a name="warnings-introduced-in-visual-c-2015-update-1"></a>Visual c + + 2015 Update 1 中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19.00.23500__。  
...
## <a name="warnings-introduced-in-visual-c-2015-rtm"></a>在 Visual c + + 2015 RTM 中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:19__。  
...
C4473|'*描述*': 沒有足夠的引數傳遞給格式字串
C4474|'*描述*': 太多引數傳遞給格式字串
C4475|'*描述*': 長度修飾詞'*修飾詞*'不能與型別欄位字元'*字元*' 格式規範中
C4476|'*描述*': 未知的型別欄位字元'*字元*' 格式規範中
C4477|'*描述*': 格式字串'*字串*'需要類型的引數'*類型*'，但 variadic 引數*數目*具有類型 '*類型*'
C4478|'*描述*': 無法在相同的格式字串中混合位置和非位置的預留位置
...
## <a name="warnings-introduced-in-visual-c-2013"></a>在 Visual c + + 2013年中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:18__。  
...
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:17__。  
...
## <a name="warnings-introduced-in-visual-c-2010"></a>Visual c + + 2010年中引進的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:16__。  
...
## <a name="warnings-introduced-in-visual-c-2008"></a>Visual c + + 2008年中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:15__。  
...
## <a name="warnings-introduced-in-visual-c-2005"></a>Visual c + + 2005年中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:14__。  
...
## <a name="warnings-introduced-in-visual-c-2003"></a>在 Visual c + + 2003 中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:13.10__。  
...
## <a name="warnings-introduced-in-visual-c-2002"></a>Visual c + + 2002年中導入的警告  
  
使用編譯器選項會抑制這些警告和更新版本中的所有警告__/Wv:13__。  
...
C4371|'*宣告*': 類別配置可能已從舊版編譯器因為的成員有更好的封裝'*類型*'
