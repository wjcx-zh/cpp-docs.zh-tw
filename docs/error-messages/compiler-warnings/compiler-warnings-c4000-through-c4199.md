...
|編譯器警告 （層級 1） C4006|#undef 後面必須有識別項|
...
|[編譯器警告 (層級 1) C4028](../../error-messages/compiler-warnings/compiler-warning-level-1-c4028.md)|型式參數 'parameter_number' 與宣告不同|
...
|編譯器警告 （層級 1） C4041|編譯器限制： 終止瀏覽器輸出|
...
|[編譯器警告 (層級 1) C4067](../../error-messages/compiler-warnings/compiler-warning-level-1-c4067.md)|未預期的語彙基元下列前置處理器指示詞-必須是新行|
|編譯器警告 （層級 1） C4068|未知的 pragma|
|編譯器警告 C4069|長雙精度為雙是相同的精確度|
...
|編譯器警告 （層級 1） C4112|#line 必須有介於 1 到 'line_count' 之間的整數|
...
|[編譯器警告 (層級 1) C4116](../../error-messages/compiler-warnings/compiler-warning-level-1-c4116.md)|在括號中的未命名的類型定義|
...
|[編譯器警告 (層級 1) C4124](../../error-messages/compiler-warnings/compiler-warning-level-1-c4124.md)|__fastcall 與堆疊檢查沒有效率|
...
|編譯器警告 （層級 4） C4152|非標準的擴充，運算式中的函式/資料指標轉換|
...
|編譯器警告 （層級 1） C4165|正在 'HRESULT' 轉換為 'bool';確定這是您想要？|
...
|編譯器警告 C4181|套用至參考類型; 限定詞忽略|
|編譯器警告 （層級 1） C4182|#include 巢狀層級為 'nest_count' 深層;可能有無限遞迴|
...
|編譯器警告 （層級 1） C4186|#import 屬性 'attribute' 需要 'argument_count' 引數。忽略|
...
|[編譯器警告 (層級 3) C4197](../../error-messages/compiler-warnings/compiler-warning-level-3-c4197.md)|'type': 已忽略最上層的 volatile 類型轉換中|
