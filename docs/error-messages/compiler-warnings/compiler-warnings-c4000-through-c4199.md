...
|警告|訊息|
|-------------|-------------|
|編譯器警告 C4000|未知的警告<br /><br /> 請選擇 Visual c + + 的 技術支援 命令<br /><br /> [說明] 功能表，或開啟技術支援說明檔，如需詳細資訊|
...
|編譯器警告 （層級 3） C4008|'function': 已忽略 '屬性' 屬性|
...
|編譯器警告 （層級 1） C4076|'type_modifier': 不可以搭配類型 'typename'|
...
|編譯器警告 （層級 4） C4131|'function': 使用舊樣式宣告子|
...
|編譯器警告 （層級 1） C4141|'modifier': 使用一次以上|
...
|編譯器警告 （層級 1） C4165|'HRESULT' 轉換為 'bool';確定這是您想要？|
|編譯器警告 （層級 1） C4166|對建構函式/解構函式的不合法呼叫慣例|
|編譯器警告 （層級 1） C4167|'function': 只能當做內建函式|
...
|編譯器警告 （層級 4） C4179|'/ / *': 剖析為 '/' 和' /\*': 與標準混淆 ' / /' 註解|
|編譯器警告 （層級 1） C4180|套用至函式類型的限定詞沒有意義; 已忽略|
|編譯器警告 C4181|套用至參考型別; 的辨識符號已忽略|
|編譯器警告 （層級 1） C4182|#include 巢狀層級為 'nest_count' 深;可能的無限遞迴|
...
|編譯器警告 （層級 1） C4186|#import 屬性 'attribute' 需要 'argument_count' 引數;已忽略|
