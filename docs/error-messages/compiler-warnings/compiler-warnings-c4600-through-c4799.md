...
|[編譯器警告 （層級 4） C4611](../../error-messages/compiler-warnings/compiler-warning-level-4-c4611.md)|'function' 之間的互動和C++物件解構是不可移植|
...
|[編譯器警告 C4687 （錯誤）](../../error-messages/compiler-warnings/compiler-warning-c4687.md)|'class': 密封抽象類別無法實作介面 'interface'|
