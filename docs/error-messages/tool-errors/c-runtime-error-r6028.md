...
> [!NOTE]
> 如果您遇到這個錯誤訊息時執行應用程式時，應用程式已關閉因為它有內部記憶體問題。 有許多原因會造成這個錯誤，但它通常會造成極低記憶體狀況，程式中的 bug 或損壞的硬體驅動程式。
>
> 您可以嘗試進行下列步驟來修正這個錯誤：
>
...
> - 請檢查您的硬體廠商的網站或**Windows Update**中**控制台**軟體和驅動程式的更新。
