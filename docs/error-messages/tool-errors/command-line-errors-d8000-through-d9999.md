...
---
# <a name="command-line-errors-and-warnings"></a>命令列錯誤與警告

在本節中的文章提供的命令列的錯誤和警告的建置工具所產生的參考。 這些訊息有表單`Dxxxx`，其中*xxxx*是四位數的數字。

[!INCLUDE[error-boilerplate](../../error-messages/includes/error-boilerplate.md)]

## <a name="command-line-error-messages"></a>命令列的錯誤訊息
...
## <a name="command-line-warning-messages"></a>命令列警告訊息
