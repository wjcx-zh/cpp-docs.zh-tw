...
ms.locfileid: "58781493"
---
# <a name="linker-tools-error-lnk1000"></a>連結器工具錯誤 LNK1000

> 未知的錯誤;如需技術支援選項，請參閱文件

請注意錯誤的情況下，然後試著找出問題，並建立可重現的測試案例。 如需如何調查與報告這些錯誤的資訊，請參閱[如何回報 Visual c + + 工具組或文件的問題](../../overview/how-to-report-a-problem-with-the-visual-cpp-toolset.md)。
