---
title: 自 ActiveX 控制項加入類別 (Visual C++)
ms.date: 09/07/2018
helpviewer_keywords:
...
1. 在[新增類別](../ide/add-class-dialog-box.md)對話方塊的 [範本] 窗格中，按一下 [來自 ActiveX 控制項的 MFC 類別]，然後按一下 [開啟]，顯示[從 ActiveX 控制項新增類別精靈](../ide/add-class-from-activex-control-wizard.md)。
