...
1. 在[新增專案](../ide/add-class-dialog-box.md)對話方塊的 [範本] 窗格中，按一下 [C++ 類別]。 按一下 [新增]，顯示 [[泛型 C++ 類別精靈]](../ide/generic-cpp-class-wizard.md)。

1. 在精靈中提供類別名稱，然後定義設定，或接受預設值。

1. 若要關閉精靈並在專案中檢視新的泛型 C++ 類別，請按一下 [完成]。
