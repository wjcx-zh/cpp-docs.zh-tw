...
1.  在**類別檢視**，展開專案節點，以顯示專案中的類別。 (若要開啟**類別檢視**，在功能表列上選擇 **檢視**，**類別檢視**。)  
  
2.  開啟您想要加入的成員函式，然後選擇 類別的捷徑功能表**新增**，**加入函式**。  
  
3.  提供成員函式的詳細資訊。 如需詳細資訊，請參閱[加入成員函式精靈](../ide/add-member-function-wizard.md)。  
