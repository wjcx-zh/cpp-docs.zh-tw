---
title: 使用應用程式精靈建立桌面專案 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
2.  在 [專案類型] 窗格中選取 [Visual C++ 專案] 資料夾。 在 [範本] 窗格中會出現各種 C++ 專案的圖示。  
  
3.  在 [範本] 窗格中，選取圖示以選擇專案類型。 窗格下面會出現訊息，指示所要建立專案的類型。  
  
4.  請指定專案屬性，或略過此步驟使用 Visual Studio 預設的專案屬性。 如需詳細資料，請參閱[使用專案屬性](../ide/working-with-project-properties.md)。  
  
5.  按一下 [確定]，屬於您專案類型的精靈便會開啟。 如果您要讀取精靈的說明主題，請按 **F1** 鍵。  
