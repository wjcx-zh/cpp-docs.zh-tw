...
ms.locfileid: "50494519"
---
# <a name="hlsl-property-pages-general"></a>HLSL 屬性頁：一般

若要設定 HLSL 編譯器 (fxc.exe) 的下列屬性，請使用其 [一般] 屬性頁。 如需如何存取 HLSL 資料夾中 [一般] 屬性頁的資訊，請參閱[使用專案屬性](../ide/working-with-project-properties.md)。
...
[HLSL 屬性頁：進階](../ide/hlsl-property-pages-advanced.md)<br>
