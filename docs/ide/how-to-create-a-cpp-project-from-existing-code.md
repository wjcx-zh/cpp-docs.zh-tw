...
[從現有的程式碼檔建立新專案精靈、指定專案位置和原始程式檔](../ide/specify-project-location-and-source-files.md)<br>
[從現有的程式碼檔建立新專案精靈、指定專案設定](../ide/specify-project-settings-create-new-project-from-existing-code-files-wizard.md)<br>
