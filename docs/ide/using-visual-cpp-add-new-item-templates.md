---
title: 使用 Visual C++ 新增項目範本 | Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-ide
...
|安裝程式類別|新增繼承自使用 CLR 功能之[安裝程式類別](https://msdn.microsoft.com/en-us/library/system.configuration.install.installer.aspx)的類別。|  
