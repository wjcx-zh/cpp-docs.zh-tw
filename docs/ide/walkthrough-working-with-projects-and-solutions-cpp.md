...
若要完成這個逐步解說，您需要 Visual Studio 2017 或更新版本。 如果您需要複本，以下是簡短指南：[在 Visual Studio 中安裝 C++ 支援](../build/vscpp-step-0-installation.md)。 如果尚未完成，請在安裝後透過 "Hello, World" 教學課程執行下列步驟，確定 C++ 元件已正確安裝且運作正常。
...
**下一個主題：** [逐步解說：建置專案 (C++)](../ide/walkthrough-building-a-project-cpp.md)
