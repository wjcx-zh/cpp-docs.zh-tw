...
layout: HubPage
ms.topic: conceptual
title: Visual C++ 文件 | Microsoft Docs
                    ...
                    <div class="cardSize">
                        <div class="cardPadding">
                            <div class="card">
                                ...
                                <div class="cardText">
                                    <h3>安裝 Visual Studio 並選擇 C++ 工作負載</h3>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通用 Windows 平台開發</h3>
                                                    <p>使用 C++ 開發適用於通用 Windows 平台 (UWP) 的應用程式。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 C++ 進行 Windows 開發</h3>
                                                    <p>使用 Win32、MFC、ATL、COM 和/或 C++/CLI，建立傳統 Windows 傳統型應用程式、靜態程式庫和 DLL。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 C++ 進行行動裝置開發</h3>
                                                    <p>建立適用於 iOS、Android 和 UWP 的行動裝置應用程式。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>使用 C++ 進行遊戲開發</h3>
                                                    <p>使用 DirectX、Unreal、Cocos2D 和其他項目建立遊戲和圖形應用程式。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Python</h3>
                                                    <p>使用 Python Tools for Visual Studio 建立與 C++ 程式互動的 Python 應用程式。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>偵錯</h3>
                                                    <p>使用 Visual Studio 偵錯工具來偵錯 C++ 程式碼。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>移植和升級</h3>
                                                    <p>升級至最新版 Visual Studio，並將舊版應用程式移轉至新型平台。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>標準 C/C++ 語言和程式庫</h3>
                                                    <p>Microsoft 的 C/C++ 程式設計語言和程式庫實作。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>元件延伸模組</h3>
                                                    <p>C++ 的元件延伸模組：C++/CLI for .NET 程式設計和 C++/CX for UWP 程式設計。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Windows 桌面程式庫</h3>
                                                    <p>Microsoft Foundation Classes (MFC) 和 Active Template Library (ATL)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>平行程式設計程式庫</h3>
                                                    <p>進行平行程式設計的 Concrt、AMP 和 OpenMP 程式庫。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>通用 Windows 平台程式庫</h3>
                                                    <p>Windows 執行階段 C++ 範本庫 (WRL) 是提供低階方式撰寫和使用 Windows 執行階段元件的範本庫。</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
