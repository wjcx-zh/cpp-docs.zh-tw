...
ms.locfileid: "78215481"
---
# <a name="x86-intrinsics-list"></a>x86 內建函式清單

本檔列出當 x86 為目標時，C++ Microsoft C/編譯器支援的內建函式。
...
|[__addfsbyte](addfsbyte-addfsword-addfsdword.md)||intrin.h|void __addfsbyte （不帶正負號的 long、不帶正負號的字元）|
...
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|不帶正負號的 int _andn_u32 （不帶正負號的整數，不帶正負號的整數）|
...
|[__readfsbyte](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|不帶正負號的 char __readfsbyte （無符號長）|
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|不帶正負號的長 __readfsdword （無符號長）|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|不帶正負號的簡短 __readfsword （無符號長）|
...
|[_udiv64](udiv64.md)||intrin.h|不帶正負號的 int \_udiv64 （未簽署的 \__int64、不帶正負號的整數 \*|
...
|[__writedr](writedr.md)||intrin.h|void __writedr （不帶正負號、不帶正負號）|
|[__writeeflags](writeeflags.md)||intrin.h|void __writeeflags(unsigned)|
|[__writefsbyte](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsbyte （不帶正負號的 long、不帶正負號的字元）|
