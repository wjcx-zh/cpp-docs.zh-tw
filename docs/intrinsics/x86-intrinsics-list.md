...
ms.locfileid: "59982391"
---
# <a name="x86-intrinsics-list"></a>x86 內建函式清單

本文件列出內建函式，Microsoft C /C++編譯器都支援 x86 為目標時。
...
|[_andn_u32](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_andn_u32)|BMI [1]|ammintrin.h|不帶正負號 int _andn_u32 （不帶正負號的 int、 不帶正負號的 int）|
...
|[_mm_monitor](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_monitor)|SSE3|intrin.h|void _mm_monitor void const *、 不帶正負號的整數 (不帶正負號的 int）|
...
|[_mm_setr_pi16](https://software.intel.com/sites/landingpage/IntrinsicsGuide/#text=_mm_setr_pi16)|MMX|intrin.h|__m64 _mm_setr_pi16 簡短、 短、 簡短 (短）|
...
|[__readfsdword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|不帶正負號的長 __readfsdword(unsigned long)|
|[__readfsword](readfsbyte-readfsdword-readfsqword-readfsword.md)||intrin.h|不帶正負號的短 __readfsword(unsigned long)|
...
|[__writefsword](writefsbyte-writefsdword-writefsqword-writefsword.md)||intrin.h|void __writefsword (不帶正負號的 long、 unsigned short)|
