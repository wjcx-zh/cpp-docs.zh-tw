...
| C 語言標準 | 決定 C 語言標準。 | **預設**<br/>**C89** - C89 語言標準。<br/>**C99** - C99 語言標準。<br/>**C11** - C11 語言標準。<br/>**C99 (GNU 方言)** - C99 (GNU 方言) 語言標準。<br/>**C11 (GNU 方言)** - C11 (GNU 方言) 語言標準. |
| C + + 語言標準 | 決定 C++ 語言標準。 | **預設**<br/>**C++03** - C++03 語言標準。<br/>**C++11** - C++11 語言標準。<br/>**C++14** - C++14 語言標準。<br/>**C++03 (GNU 方言)** - C++03 (GNU 方言) 語言標準。<br/>**C++11 (GNU 方言)** - C++11 (GNU 方言) 語言標準。<br/>**C++14 (GNU 方言)** - C++14 (GNU 方言) 語言標準。 |

## <a name="advanced"></a>進階

| 屬性 | 描述 | Choices |
|--|--|--|
| 編譯為 | 選取 .c 和 .cpp 檔的編譯語言選項。 (-x c、-x c++) | **預設** - 根據 .c 或 .cpp 副檔名進行偵測。<br/>**編譯為 C 代碼**- 編譯為 C 代碼。<br/>**編譯為C++代碼**- 編譯為C++代碼。 |
| 強制的 Include 檔案 | 指定一或多個強制的 Include 檔案。(-include \[名稱]) |
