...
##### [Automation 用戶端：使用型別程式庫](automation-clients-using-type-libraries.md)
...
##### [剪貼簿：新增其他格式](clipboard-adding-other-formats.md)
...
#### [逐步解說：將 CTaskDialog 新增至應用程式](walkthrough-adding-a-ctaskdialog-to-an-application.md)
...
#### [Windows Sockets：資料通訊端](windows-sockets-datagram-sockets.md)
...
#### [Windows Sockets：通訊端通知](windows-sockets-socket-notifications.md)
...
## [TN020：識別碼命名和編號慣例](tn020-id-naming-and-numbering-conventions.md)
