---
title: "使用程式碼精靈建立對話方塊類別 |Microsoft 文件"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[Windows 訊息對應](../mfc/handling-windows-messages-in-your-dialog-box.md)到對話方塊類別。|您要處理的每個訊息。|  
...
-   [建立對話方塊類別](../mfc/creating-your-dialog-class.md)  
