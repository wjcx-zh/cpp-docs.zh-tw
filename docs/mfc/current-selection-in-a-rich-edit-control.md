...
您可以使用[FindText](../mfc/reference/cricheditctrl-class.md#findtext)成員函式來搜尋 rich edit 控制項中的字串, 此函式與此函式搭配使用的[FINDTEXTEX](/windows/win32/api/richedit/ns-richedit-findtextexw)結構會指定要搜尋的文字範圍和要搜尋的字串。 您也可以指定這些選項, 如同搜尋是否區分大小寫。
