---
title: 標題控制項中的標頭項目 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
您有相當大的控制權的外觀和行為的標題項目組成標題控制項 ([CHeaderCtrl](../mfc/reference/cheaderctrl-class.md))。 每個標題項目可以有字串、點陣圖影像、來自相關聯影像清單的影像，或與其關聯之應用程式所定義的 32 位元值。 字串、點陣圖或影像會在標題項目中顯示。  
 ...
 您藉由呼叫來建立可自訂外觀和內容的新項目[cheaderctrl:: Insertitem](../mfc/reference/cheaderctrl-class.md#insertitem)或修改現有的項目，藉由呼叫[cheaderctrl:: Getitem](../mfc/reference/cheaderctrl-class.md#getitem)和[Cheaderctrl:: Setitem](../mfc/reference/cheaderctrl-class.md#setitem)。  
