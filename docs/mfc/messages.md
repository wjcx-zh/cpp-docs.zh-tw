...
ms.locfileid: "36928337"
---
# <a name="messages"></a>訊息
中的訊息迴圈`Run`類別成員函式`CWinApp`擷取佇列的各種事件所產生的訊息。 例如，當使用者按一下滑鼠時，Windows 會傳送數個滑鼠相關訊息，例如 WM_LBUTTONDOWN 時按下滑鼠左鍵和 WM_LBUTTONUP 放開滑鼠左的按鈕。 架構的應用程式訊息迴圈實作會將訊息分派至適當視窗。  
