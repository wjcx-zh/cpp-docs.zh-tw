---
title: MFC ActiveX 控制項： 加入 ActiveX 控制項中的內建事件 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
|按鍵動作|**void FireKeyPress (簡短** <strong>\*</strong> `pnChar` **)** |時引發`WM_CHAR`接收訊息。<br /><br /> 事件對應項目： **EVENT_STOCK_KEYPRESS （)**|  
...
2.  類別檢視 中以滑鼠右鍵按一下您的 ActiveX 控制項類別，若要開啟快顯功能表。  
  
3.  從快顯功能表中，按一下**新增**，然後按一下**新增事件**。  
