...
7.  在 **屬性型別**方塊中，選取**IDispatch** <strong>\*</strong>屬性的類型。  
...
## <a name="see-also"></a>另請參閱  
 ...
 [MFC ActiveX 控制項： 使用 ActiveX 控制項中的圖片](../mfc/mfc-activex-controls-using-pictures-in-an-activex-control.md)   
