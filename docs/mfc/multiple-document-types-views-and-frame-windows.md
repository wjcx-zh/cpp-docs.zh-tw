...
![多&#45;個 view 使用者介面](../mfc/media/vc37a71.gif "多&#45;個 view 使用者介面") <br/>
多個檢視使用者介面
...
如需 的詳細資訊，請參閱＜MFC 參考＞ 中的 *`UpdateAllViews`[ 類別 CView](../mfc/reference/cview-class.md)* 和 [Scribble 範例](../overview/visual-cpp-samples.md)。
...
如需詳細資訊，請參閱*＜MFC 參考＞* 中的 [CSplitterWnd](../mfc/reference/csplitterwnd-class.md) 類別 和 [MFC 範例](../overview/visual-cpp-samples.md#mfc-samples)。

## <a name="see-also"></a>另請參閱

[檔/視圖架構](../mfc/document-view-architecture.md)
