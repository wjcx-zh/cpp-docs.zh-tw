...
若要為特定裝置格式化 rich edit 控制項的部分內容, 您可以使用[FormatRange](../mfc/reference/cricheditctrl-class.md#formatrange)成員函式。 搭配此函式使用的[FORMATRANGE](/windows/win32/api/richedit/ns-richedit-formatrange)結構會指定要格式化的文字範圍, 以及目標裝置的裝置內容 (DC)。
