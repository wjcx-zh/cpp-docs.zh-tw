...
## <a name="remarks"></a>備註  
 ...
 每個裝置有其獨特的色彩格式。 若要從一部裝置的點陣圖傳輸到另一個中，使用[GetDIBits](http://msdn.microsoft.com/library/windows/desktop/dd144879)並[SetDIBits](http://msdn.microsoft.com/library/windows/desktop/dd162973) Windows 函式。  
