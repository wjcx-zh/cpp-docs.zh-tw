...
|-|-|  
|參數|描述|  
|[in]*rect*|矩形的參考。 方法會在此矩形內，儲存停駐位置的大小。|  
...
|-|-|  
|參數|描述|  
|[in]*pAutoHideToolbar*|指標[CMFCAutoHideBar](../../mfc/reference/cmfcautohidebar-class.md)物件窗格位於`CAutoHideDockSite`。|  
