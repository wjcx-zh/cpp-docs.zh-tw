...
*lpRect*<br/>
指標[RECT](/previous-versions/dd162897\(v=vs.85\))結構，其中包含的座標，像素為單位，可定義物件的週框矩形*hwndParent*。
...
*pIID*<br/>
介面識別碼的指標 ( [GUID](/previous-versions/aa373931\(v=vs.80\)))。
...
*guid*<br/>
[GUID](/previous-versions/aa373931\(v=vs.80\))的型別描述。
