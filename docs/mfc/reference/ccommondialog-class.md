...
helpviewer_keywords: 
  ...
  - "對話方塊 [C++], Windows common dialogs"
  - "dialog classes [C++], common"
  - "MFC 對話方塊, Windows common dialogs"
...
|名稱|描述|  
|--------|--------|  
|[CCommonDialog::CCommonDialog](../Topic/CCommonDialog::CCommonDialog.md)|建構 `CCommonDialog` 物件。|  
