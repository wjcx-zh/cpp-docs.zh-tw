---
title: CDBVariant 類別 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
### <a name="remarks"></a>備註  
 ...
 如需 TIMESTAMP_STRUCT 資料類型的詳細資訊，請參閱主題[C 資料類型](https://msdn.microsoft.com/library/ms714556.aspx)的附錄 D 中*ODBC 程式設計人員參考*Windows SDK 中。  
