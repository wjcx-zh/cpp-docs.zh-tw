...
### <a name="remarks"></a>備註  
 ...
 URL 由`lpszURL`可以不同於瀏覽器已告知瀏覽至，因為此 URL 是正式且完整的 URL 的 URL。 例如，如果應用程式的呼叫中指定的 URL"www.microsoft.com"[瀏覽](#navigate)或[Navigate2](#navigate2)，傳遞的 URL`OnNavigateComplete2`將會是"http://www.microsoft.com/taiwan/"。 此外，如果伺服器已被瀏覽器重新導向至不同的 URL、 重新導向的 URL 將會反映這裡。  
...
### <a name="remarks"></a>備註  
 ...
 請注意，在 URL 中包含*strURL*可以不同於瀏覽器已告知瀏覽至，因為此 URL 是正式且完整的 URL 的 URL。 例如，如果應用程式的呼叫中指定的 URL"www.microsoft.com"[瀏覽](#navigate)或[Navigate2](#navigate2)，傳遞的 URL`OnNavigateComplete2`將會是"http://www.microsoft.com/taiwan/"。 此外，如果伺服器已被瀏覽器重新導向至不同的 URL、 重新導向的 URL 將會反映這裡。  
