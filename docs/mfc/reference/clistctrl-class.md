...
-   知識庫文章 Q200054: PRB: OnTimer() 是不呼叫重複清單控制項  
 ...
 目前清單檢視控制項的樣式會判斷目前的檢視。 如需有關這些樣式和其用法的詳細資訊，請參閱[使用 CListCtrl： 變更清單控制項樣式](../../mfc/changing-list-control-styles.md)。  
...
-   拖曳和卸除資料行排序  
 ...
 如需使用這些新的擴充樣式，請參閱 <<c0> [ 使用 CListCtrl： 變更清單控制項樣式](../../mfc/changing-list-control-styles.md)。  
...
### <a name="remarks"></a>備註  
 這個方法會實作 Win32 巨集的行為[ListView_GetBkImage](http://msdn.microsoft.com/library/windows/desktop/bb761246)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetCheckState](http://msdn.microsoft.com/library/windows/desktop/bb761250)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetColumnOrderArray](http://msdn.microsoft.com/library/windows/desktop/bb761254)、 Windows SDK 中所述。  
...
### <a name="return-value"></a>傳回值  
 目前使用的清單中的延伸樣式的組合檢視控制項。 如需描述性的這些延伸的樣式清單，請參閱[延伸清單檢視樣式](http://msdn.microsoft.com/library/windows/desktop/bb774732)Windows SDK 中的主題。  
  
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetExtendedListViewStyle](http://msdn.microsoft.com/library/windows/desktop/bb761264)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetHeader](http://msdn.microsoft.com/library/windows/desktop/bb761290)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetHotCursor](http://msdn.microsoft.com/library/windows/desktop/bb761292)、 Windows SDK 中所述。 當游標通過任何清單檢視項目，則會出現熱資料指標，啟用浮動選取時，只顯示。 藉由設定是否啟用暫留選取**LVS_EX_TRACKSELECT**延伸樣式。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetHotItem](http://msdn.microsoft.com/library/windows/desktop/bb761294)、 Windows SDK 中所述。 熱門項目被定義為目前選取項目的熱追蹤 （和暫留選取項目） 時已啟用。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetHoverTime](http://msdn.microsoft.com/library/windows/desktop/bb761296)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 這個值是**lParam**隸屬[LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760)結構，Windows SDK 中所述  
...
### <a name="remarks"></a>備註  
 這個方法會傳送[LVM_GETITEMINDEXRECT](http://msdn.microsoft.com/library/windows/desktop/bb761046) Windows SDK 中所述的訊息。 如需詳細資訊，請參閱[ListView_GetItemIndexRect 巨集](http://msdn.microsoft.com/library/windows/desktop/bb774959)。  
...
### <a name="remarks"></a>備註  
 所指定項目的狀態**狀態**隸屬[LVITEM](http://msdn.microsoft.com/library/windows/desktop/bb774760)結構，Windows SDK 中所述。 當您指定或變更項目的狀態**stateMask**成員指定您想要變更的狀態位元。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetNumberOfWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb774988)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetSelectionMark](http://msdn.microsoft.com/library/windows/desktop/bb774998)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 訊息行為[LVM_GETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb761085)、 Windows SDK 中所述。 MFC 實作`GetToolTips`傳回`CToolTipCtrl`物件，使用清單控制項，而不是工具提示控制項的控制代碼。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_GetWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb775024)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 呼叫這個方法可能會導致**LVM_INSERTITEM**傳送至控制項視窗的訊息。 設定項目文字，在某些情況下的可能無法在控制項的相關聯的訊息處理常式 (例如使用的視窗樣式，例如**LVS_OWNERDRAW**)。 如需有關這些條件的詳細資訊，請參閱[LVM_INSERTITEM](http://msdn.microsoft.com/library/windows/desktop/bb761107) Windows SDK 中。  
...
### <a name="remarks"></a>備註  
 ...
 這個方法會傳送[LVM_MAPINDEXTOID](http://msdn.microsoft.com/library/windows/desktop/bb761139) Windows SDK 中所述的訊息。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetColumnOrderArray](http://msdn.microsoft.com/library/windows/desktop/bb775072)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetExtendedListViewStyle](http://msdn.microsoft.com/library/windows/desktop/bb775076)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetHotCursor](http://msdn.microsoft.com/library/windows/desktop/bb775082)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetHotItem](http://msdn.microsoft.com/library/windows/desktop/bb775083)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetHoverTime](http://msdn.microsoft.com/library/windows/desktop/bb775084)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetIconSpacing](http://msdn.microsoft.com/library/windows/desktop/bb775085)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetItemCount](http://msdn.microsoft.com/library/windows/desktop/bb775093)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetItemCountEx](http://msdn.microsoft.com/library/windows/desktop/bb775095)中, 所述 Windows SDKand 只能呼叫虛擬清單檢視。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetSelectionMark](http://msdn.microsoft.com/library/windows/desktop/bb775112)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 訊息行為[LVM_SETTOOLTIPS](http://msdn.microsoft.com/library/windows/desktop/bb761216)、 Windows SDK 中所述。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SetWorkAreas](http://msdn.microsoft.com/library/windows/desktop/bb775128)、 Windows SDK 中所述。  
...
>  在排序過程中，清單檢視內容是不穩定。 如果回呼函式會傳送任何訊息至清單檢視控制項以外[LVM_GETITEM](http://msdn.microsoft.com/library/windows/desktop/bb774953)，會有無法預期的結果。  
 ...
 這個方法會傳送[LVM_SORTITEMSEX](http://msdn.microsoft.com/library/windows/desktop/bb761228) Windows SDK 中所述的訊息。  
...
### <a name="remarks"></a>備註  
 此成員函式實作的 Win32 巨集行為[ListView_SubItemHitTest](http://msdn.microsoft.com/library/windows/desktop/bb775135)、 Windows SDK 中所述。  
