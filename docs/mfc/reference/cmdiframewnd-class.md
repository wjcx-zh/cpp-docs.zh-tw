---
title: CMDIFrameWnd 類別 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
這個範例是摘錄自眭妎踱恅 Q201045，「 如何： 將多個視窗類型新增至非文件/檢視 MDI 應用程式。 」 知識庫文件位於[ http://support.microsoft.com ](http://support.microsoft.com/)。
