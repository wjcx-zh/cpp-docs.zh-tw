...
### <a name="parameters"></a>參數  
 ...
 [in]*圖示*  
 以零起始的索引，在受保護的圖示`CImageList m_Images`成員。  
...
### <a name="parameters"></a>參數  
 ...
 [in]*uiImageId*  
 從影像清單的映像識別碼。 索引標籤控制項的新索引標籤為圖示使用此映像。  
  
 [in]*uiResTabLabel*  
 標籤的資源識別碼。  
  
 [in]*bDetachable*  
 布林值參數，判斷是否可以中斷連結的新索引標籤。  
...
### <a name="parameters"></a>參數  
 [in]*dockMethod*  
 所提供的列舉的資料型別[CBasePane 類別](../../mfc/reference/cbasepane-class.md)。 此資料型別會指定用來中斷連結索引標籤的方法。  
  
 [in]*nTabNum*  
 要卸離 索引標籤的以零為起始的索引。  
  
 [in]*bHide*  
 布林值參數，指出架構是否應該隱藏 [中斷連結] 索引標籤。  
...
### <a name="parameters"></a>參數  
 [in]*rectTabAreaTop*  
 對 `CRect` 物件的參考。 `GetTabArea` 您可以使用這個物件來儲存的大小和最上層索引標籤區域的位置。  
  
 [in]*rectTabAreaBottom*  
 對 `CRect` 物件的參考。 `GetTabArea` 您可以使用這個物件來儲存的大小和底部的索引標籤區域的位置。  
...
### <a name="parameters"></a>參數  
 ...
 [out]*rect*  
 對 `CRect` 物件的參考。 此方法將此參數中儲存的大小和索引標籤的位置。  
...
### <a name="parameters"></a>參數  
 [in]*iTab*  
 以零起始的索引 索引標籤的`SetActiveTab`將與這個索引標籤設為作用中。  
...
### <a name="parameters"></a>參數  
 [in]*bNoPrefix*  
 如果您想要處理的前置詞的字元，則為 TRUE否則為 FALSE。  
  
 [in]*bRedraw*  
 如果您想要重繪索引標籤式的視窗中，則為 TRUE否則為 FALSE。  
...
### <a name="parameters"></a>參數  
 [in]*uiID*  
 點陣圖的資源識別碼。 `SetImageList` 從這個資源中載入的影像清單。  
...
### <a name="parameters"></a>參數  
 ...
 [in]*uiIcon*  
 [新增] 圖示的圖示識別碼。 此識別碼會參考內部[CImageList](../../mfc/reference/cimagelist-class.md)物件。  
...
### <a name="parameters"></a>參數  
 ...
 布林值參數，決定是否在架構顯示工具提示會顯示只有圖示的索引標籤。  
