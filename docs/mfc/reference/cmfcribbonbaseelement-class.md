...
|名稱|描述|
|----------|-----------------|
|[CMFCRibbonBaseElement::AddToKeyList](#addtokeylist)|Keytip 的功能區項目將陣列的按鍵提示。|
|[CMFCRibbonBaseElement::AddToListBox](#addtolistbox)|將功能區項目加入至指定的功能區命令清單方塊中。|
|[CMFCRibbonBaseElement::CanBeAddedToQuickAccessToolBar](#canbeaddedtoquickaccesstoolbar)|表示功能區項目是否可以加入至快速存取工具列。|
|[CMFCRibbonBaseElement::CanBeCompacted](#canbecompacted)|指出是否可壓縮功能區項目的大小。|
...
|[CMFCRibbonBaseElement::CleanUpSizes](#cleanupsizes)|清除的維度設定的功能區項目。|
...
|[CMFCRibbonBaseElement::Find](#find)|如果它指向目前物件，則您可以返回功能區項目指定的指標。|
|[CMFCRibbonBaseElement::FindByData](#findbydata)|如果它包含指定的資料，請擷取功能區項目的指標。|
|[CMFCRibbonBaseElement::FindByID](#findbyid)|擷取功能區元素的指標，如果該元素由指定的命令識別碼。|
|[CMFCRibbonBaseElement::FindByOriginal](#findbyoriginal)|如果其原始的功能區項目符合指定的功能區項目，請擷取功能區項目的指標。|
...
|[CMFCRibbonBaseElement::GetDroppedDown](#getdroppeddown)|如果其快顯功能表拉下時，會擷取功能區項目的指標。|
...
|[CMFCRibbonBaseElement::GetID](#getid)|傳回功能區項目的命令識別碼。|
...
|[CMFCRibbonBaseElement::GetKeys](#getkeys)|傳回功能區項目相關聯的 keytip。|
|[CMFCRibbonBaseElement::GetKeyTipRect](#getkeytiprect)|擷取 keytip 的邊界矩形，功能區項目。|
|[CMFCRibbonBaseElement::GetKeyTipSize](#getkeytipsize)|擷取 keytip 的文字大小。|
|[CMFCRibbonBaseElement::GetLocationInGroup](#getlocationingroup)|表示功能區中的項目在功能區群組的顯示位置。|
|[CMFCRibbonBaseElement::GetMenuKeys](#getmenukeys)|傳回與按鈕相關聯的 keytips。|
|[CMFCRibbonBaseElement::GetNotifyID](#getnotifyid)|擷取的功能區項目通知命令識別碼。|
|[CMFCRibbonBaseElement::GetOriginal](#getoriginal)|擷取原始的功能區項目。|
|[CMFCRibbonBaseElement::GetParentCategory](#getparentcategory)|擷取功能區項目的功能區分類。|
|[CMFCRibbonBaseElement::GetParentPanel](#getparentpanel)|擷取功能區面板，其中包含的功能區項目。|
|[CMFCRibbonBaseElement::GetParentRibbonBar](#getparentribbonbar)|擷取父功能區列的功能區項目。|
...
|[CMFCRibbonBaseElement::GetQuickAccessToolBarID](#getquickaccesstoolbarid)|位於快速存取工具列時，請擷取功能區項目的命令 ID。|
|[CMFCRibbonBaseElement::GetRect](#getrect)|傳回功能區項目的週框。|
...
|[CMFCRibbonBaseElement::HasFocus](#hasfocus)|指出父項目是否具有鍵盤焦點。|
...
|[CMFCRibbonBaseElement::HasMenu](#hasmenu)|指出功能區項目是否有一個功能表。|
|[CMFCRibbonBaseElement::HitTest](#hittest)|如果指定的點位於會擷取功能區項目的指標。|
|[CMFCRibbonBaseElement::IsAlignByColumn](#isalignbycolumn)|表示功能區項目是否會垂直對齊與其他功能區項目。|
|[CMFCRibbonBaseElement::IsAlwaysLargeImage](#isalwayslargeimage)|表示功能區項目影像大小是否永遠大型。|
|[CMFCRibbonBaseElement::IsAutoRepeatMode](#isautorepeatmode)|指出功能區項目是否以自動重複模式。|
|[CMFCRibbonBaseElement::IsChecked](#ischecked)|指定是否要檢查的功能區項目。|
|[CMFCRibbonBaseElement::IsCompactMode](#iscompactmode)|指定功能區項目是否精簡模式。|
|[CMFCRibbonBaseElement::IsDefaultMenuLook](#isdefaultmenulook)||
|[CMFCRibbonBaseElement::IsDisabled](#isdisabled)|指定是否要停用功能區項目。|
|[CMFCRibbonBaseElement::IsDroppedDown](#isdroppeddown)|判斷功能區項目會顯示快顯功能表，並拉下時。|
|[CMFCRibbonBaseElement::IsFocused](#isfocused)|指定功能區項目是否具有焦點。|
|[CMFCRibbonBaseElement::IsGalleryIcon](#isgalleryicon)|指出功能區項目是否包含在功能區圖庫中。|
|[CMFCRibbonBaseElement::IsHighlighted](#ishighlighted)|指定功能區項目是否會反白顯示。|
...
|[CMFCRibbonBaseElement::IsMenuMode](#ismenumode)|指出功能區項目是否包含在功能表中。|
...
|[CMFCRibbonBaseElement::IsShowGroupBorder](#isshowgroupborder)|指出是否要將功能區項目包含的群組中，顯示常見的框線。|
...
|[CMFCRibbonBaseElement::IsTextAlwaysOnRight](#istextalwaysonright)|表示功能區項目的文字是否顯示在右邊。|
...
|[CMFCRibbonBaseElement::NotifyHighlightListItem](#notifyhighlightlistitem)|功能區列的父視窗時通知使用者會反白顯示清單中的功能區項目。|
...
|[CMFCRibbonBaseElement::OnChangeMenuHighlight](#onchangemenuhighlight)|功能區項目的功能表中的反白顯示的變更時由架構呼叫。|
|[CMFCRibbonBaseElement::OnDraw](#ondraw)|由架構呼叫以繪製功能區項目。|
|[CMFCRibbonBaseElement::OnDrawKeyTip](#ondrawkeytip)|由架構呼叫以繪製功能區項目的 keytip。|
|[CMFCRibbonBaseElement::OnDrawMenuImage](#ondrawmenuimage)|繪製功能表圖像，功能區項目時，由架構呼叫。|
|[CMFCRibbonBaseElement::OnDrawOnList](#ondrawonlist)|由架構呼叫以繪製命令的清單方塊中的功能區項目。|
|[CMFCRibbonBaseElement::OnKey](#onkey)|當使用者按下 keytip 和功能區項目取得焦點時，由架構呼叫。|
...
|[CMFCRibbonBaseElement::OnShowPopupMenu](#onshowpopupmenu)|當功能區項目便會顯示快顯功能表時，由架構呼叫。|
...
|[CMFCRibbonBaseElement::SetData](#setdata)|關聯的功能區項目中的資料項目。|
...
|[CMFCRibbonBaseElement::SetID](#setid)|設定功能區項目的命令識別碼。|
|[CMFCRibbonBaseElement::SetInitialMode](#setinitialmode)|設定功能區項目的初始的顯示大小。|
|[CMFCRibbonBaseElement::SetKeys](#setkeys)|設定功能區項目的 keytip。|
|[CMFCRibbonBaseElement::SetOriginal](#setoriginal)|設定功能區項目的原始的功能區項目。|
|[CMFCRibbonBaseElement::SetParentCategory](#setparentcategory)|設定功能區項目的父類別。|
|[CMFCRibbonBaseElement::SetParentMenu](#setparentmenu)|設定父功能表功能區項目的容器。|
|[CMFCRibbonBaseElement::SetParentRibbonBar](#setparentribbonbar)|設定功能區項目之父功能區列。|
|[CMFCRibbonBaseElement::SetRect](#setrect)|設定他顯示功能區項目的矩形維度受。|
|[CMFCRibbonBaseElement::SetText](#settext)|設定功能區項目的文字。|
|[CMFCRibbonBaseElement::SetTextAlwaysOnRight](#settextalwaysonright)|設定功能區項目，以在右側顯示的文字。|
...
|[CMFCRibbonBaseElement::StretchHorizontally](#stretchhorizontally)|會自動縮放功能區項目的寬度。|
...
`CMFCRibbonBaseElement`類別會定義屬性通用於所有包含的命令識別碼、 文字標籤、 工具提示文字、 項目描述和狀態 （這可以是已取得焦點，反白顯示、 按下、 停用、 檢查，或卸除向下） 的功能區項目。

功能區項目的映像大小由所定義`RibbonImageType`成員，這可以是下列值之一：

- `RibbonImageLarge`

- `RibbonImageSmall`

根據其大小，是小型或大型的映像，會顯示功能區項目。

## <a name="example"></a>範例

下例示範如何在 `CMFCRibbonBaseElement` 類別中使用各種方法。 此範例示範如何取得`CMFCRibbonBaseElement`物件從`CMFCRibbonStatusBar`類別、 設定功能區項目的描述、 設定的文字、 設定 keytip，並設定功能區項目的工具提示文字。 這段程式碼片段是 [Draw 用戶端範例](../../overview/visual-cpp-samples.md)的一部分。
...
*arElems*<br/>
[in]若要參考[CArray](../../mfc/reference/carray-class.md)的按鍵提示。

### <a name="remarks"></a>備註

啟用功能區按鍵提示 」 功能時，架構會顯示功能區按鍵提示，當使用者按下 ALT 鍵或 F10 鍵。

##  <a name="addtolistbox"></a>  CMFCRibbonBaseElement::AddToListBox

將功能區項目加入至指定的功能區命令清單方塊中。
...
如果功能區項目的大小可以精簡;，則為 TRUE。否則為 FALSE。

### <a name="remarks"></a>備註

Compact、 中級、 或大型，可以是功能區項目的大小。
...
依預設此方法一律會傳回 TRUE。 覆寫此方法，以表示功能區項目的高度是否可以垂直地增加至功能區列的高度。
...
依預設這個方法一律會傳回 FALSE。 覆寫這個方法，以指出是否可以變更功能區項目的寬度。
...
依預設這個方法沒有任何作用。 覆寫此方法來重設的維度設定的功能區項目在衍生類別中。
...
*src*<br/>
[in]來源[CMFCRibbonBaseElement](../../mfc/reference/cmfcribbonbaseelement-class.md)物件。
...
功能區項目的指標如果*pElement*指向目前物件; 否則為 NULL。

### <a name="remarks"></a>備註

##  <a name="findbydata"></a>  CMFCRibbonBaseElement::FindByData

如果它包含指定的資料，請擷取功能區項目的指標。
...
如果它包含指定的資料中，功能區元素的指標否則為 NULL。

### <a name="remarks"></a>備註

##  <a name="findbyid"></a>  CMFCRibbonBaseElement::FindByID

擷取功能區元素的指標，如果該元素由指定的命令識別碼。
...
如果該項目由指定的命令 ID; 的功能區項目指標否則為 NULL。

### <a name="remarks"></a>備註

##  <a name="findbyoriginal"></a>  CMFCRibbonBaseElement::FindByOriginal

擷取目前的功能區元素的指標，如果其原始的功能區項目符合指定的功能區項目。
...
如果其原始的功能區項目符合指定的功能區項目的功能區元素的指標否則為 NULL。

### <a name="remarks"></a>備註

功能區項目複製到另一個容器，保留原始的功能區項目的指標。
...
功能區項目描述。 描述會顯示 [狀態] 列中，或在工具提示，或在功能表按鈕底下，如果功能區項目位於[CMFCRibbonMainPanel 類別](../../mfc/reference/cmfcribbonmainpanel-class.md)。

##  <a name="getdroppeddown"></a>  CMFCRibbonBaseElement::GetDroppedDown

如果其快顯功能表拉下時，會擷取功能區項目的指標。
...
*bIsMenu*<br/>
[in]如果功能區項目會顯示快顯功能表中，則為 TRUE否則為 FALSE。
...
|`RibbonElementMiddleInGroup`|功能區項目不會顯示在功能區群組的任一端上。|
...
功能表 keytip 的功能區項目相關聯。

### <a name="remarks"></a>備註

叫用時，功能表 keytip 就會顯示快顯功能表。
...
如果方法成功; 的功能區項目之上方層級的功能區列的指標否則為 NULL。
...
功能區項目有中繼模式，FALSE 否則，其值為 TRUE。 在中繼模式中，項目會顯示小型影像和文字右側的映像。
...
在功能區項目具有大型的模式，則為 TRUE。 FALSE 否則。
...
依預設這個方法一律會傳回 FALSE。 在衍生類別來表示功能區項目是否具有功能表中的，這個方法會覆寫。
...
如果有的話，功能區元素的指標否則為 FALSE。

### <a name="remarks"></a>備註

依預設這個方法一律會傳回有效的指標至功能區項目時存在。 覆寫此方法，指出是否點位於功能區項目。

##  <a name="isalignbycolumn"></a>  CMFCRibbonBaseElement::IsAlignByColumn

表示功能區項目是否會垂直對齊與其他功能區項目。
...
依預設此方法一律會傳回 TRUE。 覆寫此方法在衍生類別，表示衍生的功能區項目是否會垂直對齊與其他功能區項目。
...
如果功能區項目影像的大小一律為大型;，則為 TRUE。否則為 FALSE。
...
依預設這個方法一律會傳回 FALSE。 覆寫此方法，以表示功能區項目是否以自動重複模式。

在自動重複的模式，在設定的間隔，在回應的功能區項目以持續的使用者輸入以毫秒為單位。
...
如果功能區項目為精簡的模式，則為 TRUE否則為 FALSE。
...
如果功能區項目設定為顯示為快顯的命令;，則為 TRUE。否則為 FALSE。
...
如果功能區項目拉下時，並顯示快顯功能表中，則為 TRUE否則為 FALSE。
...
依預設這個方法一律會傳回 FALSE。 覆寫此方法在衍生類別，表示功能區項目是否包含在功能區圖庫中。
...
如果功能區項目會反白顯示;，則為 TRUE。否則為 FALSE。
...
如果功能區項目的影像中繼大小;，則為 TRUE。否則為 FALSE。
...
如果功能區項目包含功能表; 中，則為 TRUE。否則為 FALSE。
...
如果使用者按一下功能區項目，則為 TRUE否則為 FALSE。
...
如果功能區項目包含在快速存取工具列中，則為 TRUE否則為 FALSE。
...
如果包含在群組中的功能區項目，則為 TRUE，會顯示常見的框線;否則為 FALSE。
...
如果工具提示會顯示在功能區項目中;，則為 TRUE。如果在指標附近顯示工具提示，則為 FALSE。
...
依預設此方法一律會傳回 TRUE。 覆寫此方法，指出是否可以使用鍵盤選取功能區項目。
...
如果功能區項目的文字會顯示在右側，則為 TRUE否則為 FALSE。
...
依預設這個方法一律會傳回 FALSE。 覆寫這個方法，以指出功能區項目的顯示高度是否包含它的功能區面板的顯示高度相同。
...
*bWithDelay*<br/>
[in]True 表示將命令通知新增至訊息佇列的父視窗;立即將訊息傳送至父視窗，則為 FALSE。
...
依預設這個方法會更新功能區項目的工具提示。 覆寫這個方法，以變更其顯示矩形後更新的功能區項目。
...
依預設這個方法一定會傳回 FALSE。 覆寫這個方法，以處理持續性的使用者輸入。
...
依預設這個方法沒有任何作用。 覆寫這個方法，以更新功能區項目，反白顯示的變更時，它位於功能表。
...
命令清單方塊會顯示，讓使用者可以自訂快速存取工具列功能區項目。

##  <a name="onkey"></a>  CMFCRibbonBaseElement::OnKey

當使用者按下 keytip 和功能區項目取得焦點時，由架構呼叫。
...
當使用者按下 [main] 面板上的功能表 keytip 時由架構呼叫。
...
依預設這個方法一律會傳回 FALSE。 覆寫這個方法，以回應使用者按主面板功能表 keytip 時。
...
依預設這個方法沒有任何作用。 覆寫這個方法，以配置會變更方向時，調整的功能區項目。 預設的版面配置方向是由左到右。
...
如果您想要應用程式以處理功能區項目的焦點變更，請覆寫這個方法在衍生類別中。
...
這個方法會通知功能區列的父視窗的功能區項目，就會顯示快顯功能表。
...
*bCompactMode*<br/>
[in]若要縮小顯示功能區項目，則為 TRUE若要增加的功能區元素的顯示大小，則為 FALSE。

### <a name="remarks"></a>備註

下表摘要說明此方法的邏輯。

|*bCompactMode*|目前的功能區項目大小|新的功能區項目大小|
|--------------------|---------------------------------|-----------------------------|
|true|壓縮|未變更。|
|true|中級|如果可能的話，以壓縮。|
|true|大型|如果，中繼。|
|false|壓縮|如果可能的話，有中等否則大型。|
...
[in]若要設定顯示為快顯的命令; 的功能區項目，則為 TRUE否則為 FALSE。
...
[狀態] 列中，或在工具提示，或在 [功能表] 按鈕，架構就會顯示新的描述。
...
*bOneRow*<br/>
[in]若為 true，則功能區項目，來精簡或中繼; 的顯示大小的限制否則為 FALSE。

### <a name="remarks"></a>備註

顯示的功能區項目大小可以 compact、 中級、 或大。
...
*lpszText*<br/>
[in]文字和 keytip 的功能區項目。

### <a name="remarks"></a>備註

若要設定功能區項目的 keytip，附加新行逸出序列，後面接著的 keytip 字元*lpszText*。
...
*bIsVisible*<br/>
[in]True 表示方式顯示功能區項目中;若要隱藏功能區項目，則為 FALSE。
...
依預設這個方法會產生偵錯組建中的判斷提示失敗，並因此不應該呼叫。 覆寫這個方法，以延伸功能區項目的寬度。
...
如果已設定畫面的高度;，則為 TRUE。否則為 FALSE。

### <a name="remarks"></a>備註

覆寫這個方法，以變更顯示的高度的功能區項目至指定的資料列的高度。
