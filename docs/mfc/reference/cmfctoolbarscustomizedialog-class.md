...
這個方法會藉由顯示 [**關閉**] 按鈕來擴充基類實值（ [CPropertySheet：： OnInitDialog](../../mfc/reference/cpropertysheet-class.md#oninitdialog)），方法是確定對話方塊符合目前的螢幕大小，並將 [說明 **] 按鈕移**至左下角對話方塊的。
