...
下列範例示範如何擷取的預設值`CMFCVisualManager`物件。 此程式碼片段是一部分[工作窗格範例](../../overview/visual-cpp-samples.md)。
...
下列範例示範如何使用`OnFillBarBackground`在`CMFCVisualManager`類別。 此程式碼片段是一部分[Outlook 示範範例](../../overview/visual-cpp-samples.md)。
