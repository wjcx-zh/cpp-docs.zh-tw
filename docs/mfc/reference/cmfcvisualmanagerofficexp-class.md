---
title: CMFCVisualManagerOfficeXP 類別 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
## <a name="remarks"></a>備註  
 您使用`CMFCVisualManagerOfficeXP`類別，以變更您的應用程式類似 Microsoft Office XP 的視覺外觀。  
  
## <a name="example"></a>範例  
 下列範例示範如何使用`CMFCVisualManagerOfficeXP`。 此程式碼片段是部分[桌面警示示範範例](../../visual-cpp-samples.md)。  
