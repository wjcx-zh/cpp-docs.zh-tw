---
title: COleLinkingDoc 類別 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
如需有關使用`COleLinkingDoc`，請參閱文章[容器： 實作容器](../../mfc/containers-implementing-a-container.md)並[容器： 進階功能](../../mfc/containers-advanced-features.md)。
