---
title: CPropExchange 類別 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
 ...
 *pFontDesc*  
 指標[FONTDESC](http://msdn.microsoft.com/library/windows/desktop/ms692782)結構，其中包含用於初始化的字型屬性的預設狀態的值時*pFontDispAmbient*是 NULL。  
