...
1. 呼叫此成員函式，會建立 Windows rebar 控制項，並將它附加至`CReBarCtrl`物件。
...
實作 Win32 訊息的行為[RB_IDTOINDEX](/windows/desktop/controls/rb-idtoindex)、 Windows SDK 中所述。
