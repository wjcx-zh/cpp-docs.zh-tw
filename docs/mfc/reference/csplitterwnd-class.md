---
title: CSplitterWnd 類別 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
3.  呼叫`Create`成員函式內覆寫`OnCreateClient`。  
...
3.  呼叫`CreateStatic`成員函式內覆寫[CFrameWnd::OnCreateClient](../../mfc/reference/cframewnd-class.md#oncreateclient)。  
