...
*lpSecurityAttrs*<br/>
指向[SECURITY_ATTRIBUTES](/previous-versions/windows/desktop/legacy/aa379560\(v=vs.85\))結構，指定執行緒的安全性屬性。
