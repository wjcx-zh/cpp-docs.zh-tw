...
## <a name="to-add-run-time-class-information"></a>若要新增執行階段類別資訊
...
## <a name="to-add-dynamic-creation-support"></a>若要加入動態建立支援
...
## <a name="to-add-serialization-support"></a>若要加入的序列化支援
