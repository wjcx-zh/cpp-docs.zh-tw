...
ms.locfileid: "79446805"
---
# <a name="technical-notes-by-category"></a>依分類區分的技術提示

技術提示分為下列類別。 如需技術提示的數位清單，請參閱[依號碼的技術](../mfc/technical-notes-by-number.md)提示。
...
||
|-|
|[TN038： MFC/OLE IUnknown 執行](../mfc/tn038-mfc-ole-iunknown-implementation.md)|
