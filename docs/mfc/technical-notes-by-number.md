...
ms.locfileid: "46426064"
---
# <a name="technical-notes-by-number"></a>依編號顯示的技術提示

下面的技術附註會列出加上數字，最新寫入的技術提示第一次。 如需依類別目錄的清單，請參閱 <<c0> [ 依分類區分的技術提示](../mfc/technical-notes-by-category.md)。

|number|標題|
|------------|-----------|
|71|[IOleCommandTarget 實作](../mfc/tn071-mfc-iolecommandtarget-implementation.md)|
...
|65|[Automation 伺服程式的雙重介面支援](../mfc/tn065-dual-interface-support-for-ole-automation-servers.md)|
|64|[Apartment Model 執行緒中 OLE 控制項](../mfc/tn064-apartment-model-threading-in-activex-controls.md)|
|63|[偵錯網際網路 MFC 延伸模組 Dll](../mfc/tn063-debugging-internet-extension-dlls.md)|
|62|[Windows 控制項的訊息反映](../mfc/tn062-message-reflection-for-windows-controls.md)|
|61|[ON_NOTIFY 和 WM_NOTIFY 訊息](../mfc/tn061-on-notify-and-wm-notify-messages.md)|
|60|[Windows 通用控制項](../mfc/tn060-the-new-windows-common-controls.md)|
...
|57|[元件的當地語系化](../mfc/tn057-localization-of-mfc-components.md)|
|56|[當地語系化的 MFC 元件的安裝](../mfc/tn056-installation-of-localized-mfc-components.md)|
|55|[MFC ODBC 資料庫類別應用程式移轉至 MFC DAO 類別](../mfc/tn055-migrating-mfc-odbc-database-class-applications-to-mfc-dao-classes.md)|
|54|[在使用 MFC DAO 類別時直接呼叫 DAO](../mfc/tn054-calling-dao-directly-while-using-mfc-dao-classes.md)|
|53|[使用適用於 DAO 資料庫類別撰寫自訂 DFX 常式](../mfc/tn053-custom-dfx-routines-for-dao-database-classes.md)|
...
|46|[類別的註解慣例](../mfc/tn046-commenting-conventions-for-the-mfc-classes.md)|
|45|[Varchar/Varbinary 的 MFC/資料庫支援](../mfc/tn045-mfc-database-support-for-long-varchar-varbinary.md)|
|44|[MFC 支援](../mfc/tn044-mfc-support-for-dbcs.md)|
|43|[常式](../mfc/tn043-rfx-routines.md)|
...
|29|[分隔器的 Windows](../mfc/tn029-splitter-windows.md)|
...
|24|[定義的訊息和資源](../mfc/tn024-mfc-defined-messages-and-resources.md)|
