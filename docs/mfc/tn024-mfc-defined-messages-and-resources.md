---
title: TN024： 定義的訊息和資源 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-mfc
...
這是非常一般的格式，並允許任何 Windows 訊息和資料內容。 MFC 與 Visual c + + 資源編輯器僅支援 Windows 訊息的有限的子集： CB_ADDSTRING 的初始清單-選項 （資料是文字字串） 的下拉式方塊。
