...
[逐步解說：將放在工具列上的控制項](../mfc/walkthrough-putting-controls-on-toolbars.md)<br/>
現代的 MFC 工具列可以裝載控制項而非簡單的按鈕。 這篇文章說明如何執行此動作。

[逐步解說：將 D2D 物件加入至 MFC 專案](../mfc/walkthrough-adding-a-d2d-object-to-an-mfc-project.md)<br/>
示範如何將 D2D 物件加入至專案，並介紹如何使用 D2D。

[逐步解說：將動畫加入至 MFC 專案](../mfc/walkthrough-adding-animation-to-an-mfc-project.md)<br/>
示範如何將圖形化的物件加入至專案，並介紹如何以動畫顯示它。
