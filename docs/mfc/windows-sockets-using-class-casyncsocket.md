...
如果您不是高了解網路通訊，而且想要一個簡單的解決方案，使用類別[CSocket](../mfc/reference/csocket-class.md)使用`CArchive`物件。 請參閱[Windows Sockets： 使用通訊端與封存](../mfc/windows-sockets-using-sockets-with-archives.md)如需詳細資訊。
