...
---
# 無法建立類別 &#39;&lt;類別名稱&gt;&#39;: &lt;錯誤&gt;
類別初始化失敗。 一個可能原因是 [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)] 安裝損毀。  
...
2.  重新安裝 [!INCLUDE[dnprdnshort](../error-messages/tool-errors/includes/dnprdnshort_md.md)]，並重新編譯程式。  
