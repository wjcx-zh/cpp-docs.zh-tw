...
**MSB3156: 位於 '\<folder\>' 的項目 '\<package\>' 未通過 Xml 驗證。**  
 ...
 如果資訊清單 \(特別是 product.xml\) 沒有通過 XML 驗證，就會產生這個警告訊息。  後續的錯誤訊息中 \([MSBuild 錯誤 MSB3159](../misc/msbuild-error-msb3159.md) 或 [MSBuild 錯誤 MSB3160](../misc/msbuild-error-msb3160.md)\) 會列出特定問題。  
