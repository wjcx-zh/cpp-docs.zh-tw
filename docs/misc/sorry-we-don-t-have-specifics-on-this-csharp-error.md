...
很抱歉，我們沒有任何有關此錯誤的特定資訊。  您可以搜尋錯誤號碼與訊息文字，以在網路上尋找資訊。  或者，可以使用下列其中一個論壇詢問其他開發人員：  
 ...
 所提供的論壇是關於 [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] 語言語法和編譯器的問題和一般討論。  
 ...
 提供其他論壇中沒有討論之 [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] 問題的論壇。  
  
 [StackOverflow](http://stackoverflow.com/questions/tagged/c%23) \(英文\)  
 提供關於 [!INCLUDE[csprcs](../ide/includes/csprcs_md.md)] 問題的論壇。  
