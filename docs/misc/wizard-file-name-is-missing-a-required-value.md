...
精靈的 .vsz 檔案沒有擁有正確的格式。  當 .vsz 檔案已損毀或該檔來自 Visual Studio 以外的產品時，通常就會發生這個錯誤。  
  
### 若要更正這個錯誤  
  
1.  請確認精靈是 Visual Studio 精靈，然後再試一次。  
  
     \-或\-  
  
     請重新安裝 Visual Studio，以取代損毀的檔案。  
  
## 請參閱  
 [逐步解說：建立精靈](../Topic/Walkthrough:%20Creating%20a%20Wizard.md)