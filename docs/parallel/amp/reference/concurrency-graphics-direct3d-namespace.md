---
title: "Concurrency::graphics::direct3d 命名空間 |Microsoft 文件"
ms.custom: 
ms.date: 11/04/2016
ms.reviewer: 
ms.suite: 
...
|[make_sampler](concurrency-graphics-direct3d-namespace-functions.md#make_sampler)<br /><br /> 建立 Direct3D 取樣器狀態的介面指標的取樣器。|  
|[make_texture](concurrency-graphics-direct3d-namespace-functions.md#make_texture)<br /><br /> 建立[紋理](texture-class.md)物件使用指定的參數。|  
|[msad4](concurrency-graphics-direct3d-namespace-functions.md#msad4)<br /><br /> 比較 4 位元組參考值取值並且 8 個位元組的來源值，並且累積文件 4 加總的向量。|  
