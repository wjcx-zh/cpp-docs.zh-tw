---
title: "float_3 類別 | Microsoft Docs"
ms.custom: ""
ms.date: "11/04/2016"
ms.reviewer: ""
ms.suite: ""
...
|名稱|描述|  
|--------|--------|  
|[float\_3::float\_3 建構函式](../Topic/float_3::float_3%20Constructor.md)|多載。  預設建構函式，初始化所有元素為 0 。|  
...
|名稱|描述|  
|--------|--------|  
|[float\_3::size 常數](../Topic/float_3::size%20Constant.md)||  
