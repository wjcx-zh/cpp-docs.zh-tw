...
|名稱|描述|  
|--------|--------|  
|[float\_4::float\_4 建構函式](../Topic/float_4::float_4%20Constructor.md)|多載。  預設建構函式，初始化所有元素為 0 。|  
...
|名稱|描述|  
|--------|--------|  
|[float\_4::size 常數](../Topic/float_4::size%20Constant.md)||  
