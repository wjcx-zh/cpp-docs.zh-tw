...
|名稱|描述|  
|--------|--------|  
|[int\_3::int\_3 建構函式](../Topic/int_3::int_3%20Constructor.md)|多載。  預設建構函式，初始化所有元素為 0 。|  
...
|int\_3::set\_y 方法||  
|int\_3::set\_yx 方法||  
|int\_3::set\_yxz Method||  
|int\_3::set\_yz Method||  
|int\_3::set\_yzx 方法||  
|int\_3::set\_z 方法||  
|int\_3::set\_zx 方法||  
|int\_3::set\_zxy 方法||  
...
|--------|--------|  
|int\_3::operator\- 運算子。||  
|int\_3::operator 的 \-\- 運算子。||  
|int\_3::operator 的 %\= 運算子。||  
|int\_3::operator的&\= 運算子。||  
|int\_3::operator 的 \*\= 運算子。||  
|int\_3::operator 的 \/\= 運算子。||  
|int\_3::operator 的 ^\= 運算子。||  
|int\_3::operator 的 &#124;\= 運算子。||  
...
|名稱|描述|  
|--------|--------|  
|[int\_3::size 常數](../Topic/int_3::size%20Constant.md)||  
