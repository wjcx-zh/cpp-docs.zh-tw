---
title: HOW TO：使用 parallel_invoke 撰寫平行排序常式
ms.date: 11/04/2016
helpviewer_keywords:
...
ms.locfileid: "62252921"
---
# <a name="how-to-use-parallelinvoke-to-write-a-parallel-sort-routine"></a>HOW TO：使用 parallel_invoke 撰寫平行排序常式
