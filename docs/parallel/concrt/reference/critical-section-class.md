...
|名稱|說明|  
|----------|-----------------|  
|[critical_section 建構函式](#ctor)|建構新的重要區段。|  
...
|名稱|說明|  
|----------|-----------------|  
|[lock 方法](#lock)|取得此重要區段。|  
|[native_handle 方法](#native_handle)|傳回平台特定原生控制代碼，如果存在的話。|  
|[try_lock 方法](#try_lock)|嘗試取得鎖定，而不會封鎖。|  
|[try_lock_for 方法](#try_lock_for)|嘗試取得鎖定，而不進行特定毫秒數的封鎖。|  
|[unlock 方法](#unlock)|解除鎖定重要區段。|  
...
##  <a name="a-namecriticalsectionscopedlockclassa--criticalsectionscopedlock-class"></a><a name="critical_section__scoped_lock_class"></a>critical_section 類別  
