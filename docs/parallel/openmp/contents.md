...
[1.簡介](../../parallel/openmp/1-introduction.md)  
 ...
 [A.1 以平行方式執行簡單的迴圈](../../parallel/openmp/a-1-executing-a-simple-loop-in-parallel.md)  
  
 [A.2 指定條件式編譯](../../parallel/openmp/a-2-specifying-conditional-compilation.md)  
  
 [使用平行區域 A.3](../../parallel/openmp/a-3-using-parallel-regions.md)  
  
 [A.4 使用 nowait 子句](../../parallel/openmp/a-4-using-the-nowait-clause.md)  
  
 [A.5 使用的重要指示詞](../../parallel/openmp/a-5-using-the-critical-directive.md)  
 ...
 [指定平行區段 A.8](../../parallel/openmp/a-8-specifying-parallel-sections.md)  
  
 [A.9 使用單一指示詞](../../parallel/openmp/a-9-using-single-directives.md)  
  
 [指定循序排序 A.10](../../parallel/openmp/a-10-specifying-sequential-ordering.md)  
  
 [A.11 指定固定的執行緒數目](../../parallel/openmp/a-11-specifying-a-fixed-number-of-threads.md)  
  
 [A.12 使用不可部分完成的指示詞](../../parallel/openmp/a-12-using-the-atomic-directive.md)  
  
 [A.13 使用清單中排清的指示詞](../../parallel/openmp/a-13-using-the-flush-directive-with-a-list.md)  
  
 [A.14 使用排清的指示詞沒有清單](../../parallel/openmp/a-14-using-the-flush-directive-without-a-list.md)  
  
 [A.15 決定使用的執行緒數目](../../parallel/openmp/a-15-determining-the-number-of-threads-used.md)  
  
 [使用鎖定 A.16](../../parallel/openmp/a-16-using-locks.md)  
  
 [使用可巢狀 A.17 鎖定](../../parallel/openmp/a-17-using-nestable-locks.md)  
  
 [A.18 巢狀的 for 指示詞](../../parallel/openmp/a-18-nested-for-directives.md)  
  
 [A.19 範例會顯示不正確的巢狀工作共用指示詞](../../parallel/openmp/a-19-examples-showing-incorrect-nesting-of-work-sharing-directives.md)  
  
 [A.20 barrier 指示詞的繫結](../../parallel/openmp/a-20-binding-of-barrier-directives.md)  
  
 [私用子句 A.21 範圍變數](../../parallel/openmp/a-21-scoping-variables-with-the-private-clause.md)  
  
 [使用 default （none） 子句 A.22](../../parallel/openmp/a-22-using-the-default-none-clause.md)  
 ...
 [Copyprivate Data 屬性子句的 A.25 範例](../../parallel/openmp/a-25-examples-of-the-copyprivate-data-attribute-clause.md)  
  
 [A.26 使用 threadprivate 指示詞](../../parallel/openmp/a-26-using-the-threadprivate-directive.md)  
  
 [C99 可變長度陣列的 A.27 使用](../../parallel/openmp/a-27-use-of-c99-variable-length-arrays.md)  
  
 [Num_threads 子句的 A.28 使用](../../parallel/openmp/a-28-use-of-num-threads-clause.md)  
  
 [A.29 使用的工作共用建構內 critical 建構](../../parallel/openmp/a-29-use-of-work-sharing-constructs-inside-a-critical-construct.md)  
  
 [Reprivatization 的 A.30 使用](../../parallel/openmp/a-30-use-of-reprivatization.md)  
  
 [A.31 安全執行緒的鎖定函式](../../parallel/openmp/a-31-thread-safe-lock-functions.md)  
