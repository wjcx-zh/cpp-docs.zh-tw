---
title: 排序 （OpenMP 指示詞） |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-parallel
...
**排序**指示詞必須是動態的範圍內[如](../../../parallel/openmp/reference/for-openmp.md)或**平行 for**建構包含**排序**子句。

**排序**指示詞可支援無 OpenMP 子句。
