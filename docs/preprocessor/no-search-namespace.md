---
title: no_search_namespace |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-tools
...
**C + + 特定的**  
 ...
 具有相同的功能為[no_namespace](../preprocessor/no-namespace.md)屬性，但適用於使用 #import 指示詞中的型別程式庫[auto_search](../preprocessor/auto-search.md)屬性。  
