---
title: chi_squared_distribution 類別
ms.date: 11/04/2016
f1_keywords:
...
ms.locfileid: "72688311"
---
# <a name="chi_squared_distribution-class"></a>chi_squared_distribution 類別
...
類別樣板描述產生使用者指定之浮點類型值的分佈，或如果沒有提供，則為**double**類型，這是根據卡方分佈來散發。 下表提供各個成員的文章連結。
