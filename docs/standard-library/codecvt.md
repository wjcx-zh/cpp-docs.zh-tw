...
ms.locfileid: "68458597"
---
# <a name="ltcodecvtgt"></a>&lt;codecvt&gt;

定義數個範本類別，以依據 [codecvt](../standard-library/codecvt-class.md) 範本類別描述物件。 這些物件可以做為[地區設定 facet](../standard-library/locale-class.md#facet_class) , 以控制類型`Elem`的值序列與**char**類型的值序列之間的轉換。
