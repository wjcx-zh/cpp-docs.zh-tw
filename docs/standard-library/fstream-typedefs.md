...
另外還有 `wifstream`，這是專門用來讀取**wchar_t**雙重字元之 `basic_ifstream` 的 typedef。 如需詳細資訊，請參閱 [wifstream](../standard-library/fstream-typedefs.md#wifstream)。
...
此類型是類別樣板[basic_fstream](../standard-library/basic-fstream-class.md)的同義字，專門用於具有預設字元特性之**wchar_t**類型的元素。
...
此類型是類別樣板[basic_ifstream](../standard-library/basic-ifstream-class.md)的同義字，專門用於具有預設字元特性之**wchar_t**類型的元素。
...
此類型是類別樣板[basic_ofstream](../standard-library/basic-ofstream-class.md)的同義字，專門用於具有預設字元特性之**wchar_t**類型的元素。
...
此類型是類別樣板[basic_filebuf](../standard-library/basic-filebuf-class.md)的同義字，專門用於具有預設字元特性之**wchar_t**類型的元素。
