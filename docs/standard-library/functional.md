...
|[binary_negate](../standard-library/binary-negate-class.md)|提供成員函式的類別樣板，此函式會對指定之二元函數的傳回值進行否定運算。<br/>  (在 c + + 17 ) 中已淘汰。 |
|[binder1st](../standard-library/binder1st-class.md)|類別樣板提供的函式，會將二元函式的第一個引數系結至指定的值，以將二元函式物件轉換成一元函式物件。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[binder2nd](../standard-library/binder2nd-class.md)|類別樣板提供的函式，可將二元函式的第二個引數系結至指定的值，以將二元函式物件轉換成一元函式物件。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
...
|[const_mem_fun_ref_t](../standard-library/const-mem-fun-ref-t-class.md)|配接器類別，這個類別允許不接受引數的常數成員函式在使用參考引數初始化時，可當做一元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[const_mem_fun_t](../standard-library/const-mem-fun-t-class.md)|配接器類別，這個類別允許不接受引數的常數成員函式在使用指標引數初始化時，可當做一元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[const_mem_fun1_ref_t](../standard-library/const-mem-fun1-ref-t-class.md)|配接器類別，這個類別允許不接受單一引數的常數成員函式在使用參考引數初始化時，可當做二元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[const_mem_fun1_t](../standard-library/const-mem-fun1-t-class.md)|配接器類別，這個類別允許不接受單一引數的常數成員函式在使用指標引數初始化時，可當做二元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[default_searcher](../standard-library/default-searcher-class.md)||
|[函數](../standard-library/function-class.md)|包裝可呼叫物件的類別。|
...
|[mem_fun_ref_t](../standard-library/mem-fun-ref-t-class.md)|介面卡類別，允許 `non_const` 不接受引數的成員函式在使用參考引數初始化時，當作一元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[mem_fun_t](../standard-library/mem-fun-t-class.md)|介面卡類別，允許在 `non_const` 使用指標引數初始化時，不接受任何引數的成員函式被呼叫為一元函式物件。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
|[mem_fun1_ref_t](../standard-library/mem-fun1-ref-t-class.md)|介面卡類別，可讓 `non_const` 接受單一引數的成員函式在使用參考引數初始化時，被當作二元函式物件來呼叫。<br/>  (在 c + + 11 中被取代，請在 c + + 17 中移除。 )  |
