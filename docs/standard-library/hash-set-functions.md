...
`right` Hash_set 提供待交換，項目或其項目要與 hash_set 交換的 hash_set `left`。

`left` 其元素要與 hash_set 交換的 hash_set `right`。
...
`right` Hash_multiset 提供待交換，項目或其項目要與 hash_multiset 交換 hash_multiset `left`。

`left` 其元素要與 hash_multiset 交換的 hash_multiset `right`。
