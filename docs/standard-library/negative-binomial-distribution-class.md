...
結構 param_type {typedef negative_binomial_distribution`<`result_type > distribution_type; param_type (result_type k = 1，按兩下 p = 0.5); result_type k() const; 按兩下 p() const;
