...
此類型描述類型為**char**之元素的樣板類別[basic_RegEx 類別](../standard-library/basic-regex-class.md)的特製化。
...
此類型會針對**wchar_t**類型的元素, 描述樣板類別[basic_RegEx 類別](../standard-library/basic-regex-class.md)的特製化。
