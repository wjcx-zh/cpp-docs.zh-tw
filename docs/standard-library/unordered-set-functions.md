...
### <a name="remarks"></a>備註  
 範本函式執行 `left.`[unordered_set::swap](../standard-library/unordered-set-class.md#unordered_set__swap)`(right)`。  
...
### <a name="remarks"></a>備註  
 範本函式執行 `left.`[unordered_multiset::swap](../standard-library/unordered-multiset-class.md#unordered_multiset__swap)`(right)`。  
