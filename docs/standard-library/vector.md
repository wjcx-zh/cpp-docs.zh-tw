...
> [!NOTE]
> @No__t_0vector > 程式庫也會使用 `#include <initializer_list>` 語句。
...
|-|-|
|雜湊|傳回向量的雜湊。|
|[vector\<bool> 類別](../standard-library/vector-bool-class.md)|型別之專案的類別樣板向量的完整特製化，`bool` 具有特製化所使用之基礎類型的配置器。|
