...
ms.locfileid: "91500873"
---
# <a name="accelerator-keys-c-image-editor-for-icons"></a>圖示 (c + + 影像編輯器的快速鍵) 
...
> [!NOTE]
> 根據您目前使用的設定或版本，您所看到的對話方塊可用選項，以及功能表命令的名稱和位置，可能會與 [說明] 中描述的有所不同。 若要變更您的設定，請移至 [功能表**工具**匯  >  **入和匯出設定**]。 如需詳細資訊，請參閱 [個人化 VISUAL STUDIO IDE](/visualstudio/ide/personalizing-the-visual-studio-ide)。

|命令|索引鍵|描述|
|-------------|----------|-----------------|
|AirBrushTool|**Ctrl**  + **A**|使用具有所選大小和色彩的噴槍來繪製。|
|Image.BrushTool|**Ctrl** + **B**|使用具有選定圖形、大小和色彩的筆刷繪製。|
|CopyAndOutlineSelection|**Ctrl**  + **Shift**  + **U**|建立一份目前選取範圍的複本，並建立此複本的外框。 如果背景色彩包含在目前的選取範圍內，則會在您選取 [ [透明](./image-editor-for-icons.md) ] 時排除。|
|Image.DrawOpaque|**Ctrl** + **J**|使目前的選取範圍成為不 [透明或透明](./image-editor-for-icons.md)的。|
|Image.EllipseTool|**Ctrl**  + **P**|以選取的線條寬度和色彩繪製橢圓形。|
|EraserTool|**Ctrl**  + **Shift**  + **我**|使用目前的背景色彩) 來清除影像 (的一部分。|
...
|Image.MagnificationTool|**Ctrl**  + **M**|啟用 **放大** 工具，讓您可以放大影像的特定區段。|
|Image.Magnify|**Ctrl**  + **Shift**  + **M**|在目前的縮放比例與 1:1 縮放比例之間切換。|
|Image.NewImageType|**插入**|啟動 [ [新增 \<Device> 映射類型] 對話方塊](./creating-an-icon-or-other-image-image-editor-for-icons.md) ，您可以在此對話方塊中建立不同映射類型的影像。|
...
|Image.PencilTool|**Ctrl**  + **我**|使用單像素鉛筆繪製。|
|Image.PreviousColor|**Ctrl**  + **[**<br /><br /> - 或 -<br /><br /> **Ctrl**  + **向左箭**號|將繪圖前景色彩變更成前一個調色盤色彩。|
|Image.PreviousRightColor|**Ctrl**  + **Shift**  + **[**<br /><br /> - 或 -<br /><br /> **Shift**  + **Ctrl**  + **向左箭**號|將繪圖背景色彩變更成前一個調色盤色彩。|
|Image.RectangleSelectionTool|**Shift**  + **Alt**  + **S**|選取要移動、複製或編輯之影像的矩形部分。|
|Image.RectangleTool|ATL + R|使用選取的線條寬度和色彩繪製矩形。|
|Image.Rotate90Degrees|**Ctrl**  + **Shift**  + **H**|旋轉影像或選取範圍 90 度。|
|Image.RoundedRectangleTool|**Alt**  + **W**|以選取的線條寬度和色彩繪製圓角矩形。|
|Image.ShowGrid|**Ctrl**  + **Alt**  + **S**|切換圖元方格 (選取或清除 [[方格設定] 對話方塊](./image-editor-for-icons.md)中的 [**圖元格線**] 選項) 。|
|Image.ShowTileGrid|**Ctrl**  + **Shift**  + **Alt**  + **S**|切換磚方格 (選取或清除 [[方格設定] 對話方塊](./image-editor-for-icons.md)中的 [**磚格線**] 選項) 。|
|Image.SmallBrush|**Ctrl**  + **.** (句號)|將 **筆刷** 大小縮減為一個圖元。 (請參閱本表中的 Image.LargerBrush 和 Image.SmallerBrush)。|
|Image.SmallerBrush|**Ctrl**  +  Ctrl **-** (減號) |在每一個方向上減少一個像素的筆刷大小。 若要再次擴充筆刷的大小，請參閱本表格中的 Image.LargerBrush。|
|Image.TextTool|**Ctrl**  + **T**|開啟 [ [文字工具] 對話方塊](./image-editor-for-icons.md)。|
|UseSelectionAsBrush|**Ctrl**  + **U**|使用目前選取的範圍做為筆刷繪製。|
|Image.ZoomIn|**Ctrl**  + **Shift**  + **.** (句號)<br /><br /> - 或 -<br /><br /> **Ctrl**  + **向上鍵**|增加目前檢視的縮放比例。|
|Image.ZoomOut|**Ctrl**  + **，** (逗號) <br /><br /> - 或 -<br /><br /> **Ctrl**  + **向下箭**號|降低目前檢視的縮放比率|
...
[How to：編輯影像](selecting-an-area-of-an-image-image-editor-for-icons.md)<br/>
