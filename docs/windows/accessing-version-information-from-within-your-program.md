---
title: 存取您的程式內的版本資訊 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
如果您想要存取程式內的版本資訊，請使用 [GetFileVersionInfo](http://msdn.microsoft.com/library/windows/desktop/ms647003.aspx) 函式和 [VerQueryValue](http://msdn.microsoft.com/library/windows/desktop/ms647464.aspx) 函式。  
