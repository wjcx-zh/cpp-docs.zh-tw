---
title: 沿著右或對話方塊底部排列按鈕 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
### <a name="to-arrange-push-buttons-along-the-right-or-bottom-of-a-dialog-box"></a>若要沿著右或對話方塊底部排列按鈕  
  
1.  選取一或多個按鈕。  
  
2.  從**格式**功能表上，選擇**排列按鈕**，然後選擇下列的排列方式的其中一個：  
  
    -   **右**： 沿著對話方塊的右邊緣對齊按鈕。  
  
    -   **底部**： 對齊按鈕的對話方塊中的下邊緣。  
  
         如果您選取按鈕以外的控制項，不會影響它的位置。  
