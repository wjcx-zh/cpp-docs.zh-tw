...
ms.locfileid: "39649397"
---
# <a name="associating-menu-commands-with-status-bar-text-in-mfc-applications"></a>將功能表命令和 MFC 應用程式內的狀態列文字建立關聯
您的應用程式可以針對使用者可能選取的每一個功能表命令顯示描述性文字。 您可以將文字字串指派給每個功能表命令使用**提示**中的屬性**屬性**視窗。 如果您在 [字串表](../windows/string-editor.md) 中具有其識別碼與命令相同的字串，則當使用者將滑鼠停留在功能表項目時，MFC 應用程式將在執行中應用程式的狀態列中自動顯示此字串資源。  
