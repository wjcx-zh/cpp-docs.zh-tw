...
|[attribute](../windows/attribute.md)|可讓您建立的自訂屬性。|  
...
|[db_param](../windows/db-param.md)|將指定的成員變數，以輸入或輸出參數產生關聯。|  
...
|[importidl](../windows/importidl.md)|將指定的.idl 檔案插入至產生的.idl 檔案。|  
