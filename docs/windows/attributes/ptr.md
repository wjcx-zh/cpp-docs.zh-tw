---
title: ptr （c + + COM 屬性） |Microsoft Docs
ms.custom: ''
ms.date: 10/02/2018
ms.technology:
- cpp-windows
...
**Ptr** c + + 屬性具有相同的功能[ptr](/windows/desktop/Midl/ptr) MIDL 屬性。

## <a name="example"></a>範例

範例，請參閱[defaultvalue](defaultvalue.md)範例使用**ptr**。
