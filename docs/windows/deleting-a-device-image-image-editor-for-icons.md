---
title: 刪除裝置影像 （圖示影像編輯器） |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33881740"
---
# <a name="deleting-a-device-image-image-editor-for-icons"></a>刪除裝置影像 (圖示影像編輯器)
### <a name="to-delete-a-device-image"></a>若要刪除裝置影像  
  
1.  雖然圖示影像會顯示在**映像**編輯器中，選取**刪除裝置影像**從**映像**功能表。 當您刪除最後一個圖示影像的資源時，也會刪除資源。  
  
    > [!NOTE]
    >  當您按下 DEL 鍵時，會刪除映像和您所繪製的圖示色彩，但保留圖示;您現在可以重新設計它。 如果您不小心按下 del 鍵，您可以按 CTRL + Z 可以復原的動作。  
