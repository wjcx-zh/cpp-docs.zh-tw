---
title: 尋找二進位資料 （c + +） |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1. 從**編輯**功能表上，按一下[尋找](/visualstudio/ide/reference/find-command)。

2. 在  **Find What**方塊中，從下拉式清單中選取先前的搜尋字串或輸入您想要尋找的資料。
