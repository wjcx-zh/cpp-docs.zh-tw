---
title: "物件控制代碼運算子 (^) (C++ 元件擴充功能) | Microsoft Docs"
ms.custom: ""
ms.date: "12/16/2016"
...
「*控制代碼宣告子*」\(`^`，唸成 "hat"\) 修改型別[規範](../cpp/overview-of-declarators.md)，以表示當系統判斷宣告的物件不再可存取時，該物件應該自動刪除。  
...
## [!INCLUDE[wrt](../atl/reference/includes/wrt_md.md)]  
 ...
 如需如何具現化物件的詳細資訊，請參閱 [ref new](../windows/ref-new-gcnew-cpp-component-extensions.md)。  
...
## [!INCLUDE[clr_for_headings](../dotnet/includes/clr_for_headings_md.md)]  
 ...
 如需詳細資訊，請參閱[如何：以原生類型宣告控制代碼](../dotnet/how-to-declare-handles-in-native-types.md)。  
  
### 範例  
 **範例**  
  
 這個範例示範如何在 Managed 堆積上建立參考型別的執行個體。這個範例也示範如何以一個控制代碼初始化另一個控制代碼，導致在 Managed、記憶體回收堆積上同一個物件有兩個參考。  請注意，將 [nullptr](../windows/nullptr-cpp-component-extensions.md) 指派給一個控制代碼，不會將物件標示為進行記憶體回收。  
 ...
 **輸出**  
  ...
  **Array value: 7**  
 **Cannot access array element 11, size is 10** **範例**  
