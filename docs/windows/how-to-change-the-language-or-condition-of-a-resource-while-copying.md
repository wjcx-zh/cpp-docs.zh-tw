---
title: 如何： 在複製時變更語言或資源條件 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
-   資源的語言就是識別資源的語言。 這由[FindResource](http://msdn.microsoft.com/library/windows/desktop/ms648042) ，找出您要尋找的資源。 (不過，各語言的資源可能有與文字無關的差異，例如，只能在日文鍵盤上作用的快速鍵，或只適用於中文當地語系化組建的點陣圖等等)。  
...
1.  在.rc 檔中或[資源檢視](../windows/resource-view-window.md)視窗中，以滑鼠右鍵按一下您想要複製的資源。  
