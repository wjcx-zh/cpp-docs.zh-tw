...
ms.locfileid: "69514750"
---
# <a name="how-to-manage-resources-c"></a>作法：管理資源 (C++)
...
- 資源的語言會指定[FindResource](/windows/win32/api/winbase/nf-winbase-findresourcew)所使用的語言, 以協助識別您所尋找的資源。 資源可能會有與文字無關之每種語言的差異, 例如, 只能在日文鍵盤或點陣圖 (僅適用于中文當地語系化的組建) 上的快速鍵。
