...
選取現有的功能表名稱並按**插入**鍵或在功能表列上按一下滑鼠右鍵，然後選擇**插入新**從捷徑功能表。
...
以滑鼠右鍵按一下功能表名稱或命令，然後選擇 **刪除**從捷徑功能表。
...
> [!NOTE]
> 若要變更回功能表列檢視，請選取**快顯視窗以檢視**一次 （這會移除核取記號並傳回您的功能表列檢視）。
