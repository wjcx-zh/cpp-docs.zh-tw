---
title: Microsoft::WRL::Wrappers 命名空間 |Microsoft 文件
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
|名稱|描述|  
|----------|-----------------|  
|[CriticalSection 類別](../windows/criticalsection-class.md)|代表關鍵區段的物件。|  
...
|[Semaphore 類別](../windows/semaphore-class.md)|表示控制項可支援有限的數目的使用者共用的資源的同步處理物件。|  
|[SRWLock 類別](../windows/srwlock-class.md)|代表輕型的讀取器/寫入器鎖定。|  
