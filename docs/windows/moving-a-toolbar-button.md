---
title: 移動工具列按鈕 （c + +） |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "44315713"
---
# <a name="moving-a-toolbar-button"></a>移動工具列按鈕

### <a name="to-move-a-toolbar-button-c"></a>若要移動的工具列按鈕 （c + +）

1. 在 **工具列檢視** 窗格中，拖曳您想要移到其新的位置 工具列上的按鈕。
