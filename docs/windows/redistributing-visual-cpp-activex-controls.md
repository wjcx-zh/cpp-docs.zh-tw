...
無法在目標系統上使用這些 DLL 時，您需要使用更新對應作業系統指定的機制來更新它們。 您可以從 [http://windowsupdate.microsoft.com ](https://windowsupdate.microsoft.com) 下載 Windows 作業系統的最新 Service Pack。
