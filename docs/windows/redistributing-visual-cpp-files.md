...
> [!NOTE]
> 您來到這裡是因為想要下載其中一個 Visual C++ 執行階段檔案嗎？ 移至[Microsoft 網站](http://www.microsoft.com/)，然後輸入**Visual c + + 可轉散發套件**在搜尋方塊中。 下載並安裝電腦架構的可轉散發套件 (例如，如果您執行 64 位元 Windows，則為 x64) 以及您所需的 Visual C++ 版本 (例如 2015)。
