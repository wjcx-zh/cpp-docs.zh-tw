---
title: 用於建立使用 DirectX 的 c + + 遊戲的資源 |Microsoft Docs
ms.custom: ''
ms.date: 06/08/2018
ms.technology:
- cpp-windows
...
[DirectX 圖形和遊戲](https://msdn.microsoft.com/library/windows/desktop/ee663274)有資訊和範例，可協助您開始使用 DirectX 程式設計。
