---
title: 'Runtimeclass:: Runtimeclass 建構函式 |Microsoft 文件'
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
ms.locfileid: "33888494"
---
# <a name="runtimeclassruntimeclass-constructor"></a>RuntimeClass::RuntimeClass 建構函式
初始化 RuntimeClass 類別的目前執行個體。  
