---
title: 這些控制項調整大小，而您將它加入 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
2. 將游標放 （這會顯示當十字） 您想要在您的對話方塊上的新控制項的左上角的位置。

3. 按一下並按住滑鼠按鈕，即可在對話方塊中，控制項的左上角的錨點，然後將游標拖曳至右和向下直到控制項是您想要的大小。
