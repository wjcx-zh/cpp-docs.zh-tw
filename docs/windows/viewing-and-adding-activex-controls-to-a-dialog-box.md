---
title: 檢視及加入 ActiveX 控制項加入對話方塊 |Microsoft Docs
ms.custom: ''
ms.date: 11/04/2016
ms.technology:
- cpp-windows
...
1.  在 [[插入 ActiveX 控制項] 對話方塊](../windows/insert-activex-control-dialog-box.md)中，選取您要加入對話方塊中的控制項，然後按一下 [確定] 。  
    ...
    >  在您的系統上散發所有的 ActiveX 控制項可能不合法。 請參閱安裝這些控制項之軟體的授權合約，或連絡軟體公司。  
     ...
     您可以將控制項置於 [工具箱] 視窗內，以便於存取。 如需詳細資訊，請參閱 <<c0> [ 自訂工具箱對話方塊](http://msdn.microsoft.com/bd07835f-18a8-433e-bccc-7141f65263bb)。  
