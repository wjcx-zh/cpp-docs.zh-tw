...
- 若要顯示**色彩**] 視窗中，以滑鼠右鍵按一下**影像編輯器**窗格，然後選擇 [**顯示色彩視窗**，或選取**顯示色彩視窗**上[影像功能表](../windows/image-menu-image-editor-for-icons.md)。
...
1. 在 **影像編輯器**工具列 (或使用**映像** > **工具**)，選取**填滿**工具。
...
若要在目前的選取範圍的色彩對換上**映像**功能表上，選取**色彩對換**。
